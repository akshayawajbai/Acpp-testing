...
namespace Payroll.DAO.Schema
{
    public class SQLCommand
    {
        ...
        public enum Payroll
        {
            ...
            DeleteStaffProfile,
            SyncPRStaffGroupBankForOldMonths,//Dinesh
            #endregion
            ...
            UpdatePRStaffGroupBankForAllMonths,//Dinesh
            DeletePayrollByPayrollId,
            #endregion

            #region Payroll PRocess

            FetchPRStaff, FetchPayrollStaffGroup, FetchPProcessStaffGroup, FetchPrCompMonthStaffOrder, ReprocessDate, FetchReprocessDate,FetchPayrollComponetIdandName,
            #endregion
