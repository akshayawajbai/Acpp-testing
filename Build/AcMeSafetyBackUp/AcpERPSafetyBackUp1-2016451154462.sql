...
INSERT INTO `accounting_year` VALUES (3,'2015-04-01 00:00:00','2016-03-31 00:00:00','2015-04-01 00:00:00',1,1);
...
INSERT INTO `costcategory_costcentre` VALUES (1,29),(1,30),(1,31),(1,32),(1,33),(1,34),(1,35),(1,36),(1,37),(3,6),(3,7),(3,8),(3,9),(3,10);
...
INSERT INTO `country_symbols` VALUES ('?.?.?'),('??.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('NT$'),('K?'),('kr.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('$'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('?'),('Ft'),('kr.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('?'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('kr'),('z?'),('R$'),('fr.'),('lei'),('?.'),('kn'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('Lek'),('kr'),('?'),('TL'),('Rs'),('Rp'),('?'),('?.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('kr'),('Ls'),('Lt'),('?.?.'),('????'),('?'),('??.'),('man.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('???.'),('R'),('R'),('R'),('R'),('Lari'),('kr.'),('??'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('kr'),('RM'),('?'),('???'),('S'),('m.'),('so'),('?.'),('??'),('??'),('??'),('?'),('??'),('??'),('??'),('?'),('?'),('??'),('??'),('?'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('?'),('?'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('??'),('?.?.?'),('??.'),('$'),('ETB'),('??'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('?'),('PhP'),('?.'),('N'),('N'),('$b'),('R'),('?.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('kr.'),('N'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('$'),('$'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('$'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('?.'),('Q'),('RWF'),('XOF'),('?'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('?.?.?'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('Fr.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('$'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('fr.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('kr'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('Din.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('???.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('kr'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('$'),('???'),('?'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('$'),('DZD'),('$'),('?.?.?'),('HK$'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('$'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('$'),('???.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('S/.'),('?.?.?'),('$'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('$'),('Q'),('fr.'),('KM'),('kr'),('?.?.?'),('MOP'),('CHF'),('$'),('?'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('KM'),('kr'),('?.?.?'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('B/.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('KM'),('kr'),('?.?.?'),('R'),('RD$'),('??'),('kr'),('?.?.?'),('J$'),('Bs. F.'),('??'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('?.?.?'),('$'),('$'),('Din.'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('?.?.?'),('BZ$'),('S/.'),('???.'),('?.?.?'),('TT$'),('$'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('?.?.?'),('Z$'),('$'),('ÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢Ãƒ'),('?.?.?'),('Php'),('$'),('?.?.?'),('$U'),('?.?.?'),('Gs'),('?.?.?'),('Rs.'),('$b'),('RM'),('$'),('$'),('L.'),('C$'),('$'),('$'),('?');
...
CREATE TABLE `master_auditing_info` (
  ...
  KEY `FK_AUDIT_TYPE_ID` (`AUDIT_TYPE_ID`),
  CONSTRAINT `FK_AUDIT_TYPE_ID` FOREIGN KEY (`AUDIT_TYPE_ID`) REFERENCES `master_audit_type` (`AUDIT_TYPE_ID`),
  CONSTRAINT `FK_master_auditing_info_2` FOREIGN KEY (`DONAUD_ID`) REFERENCES `master_donaud` (`DONAUD_ID`),
...
INSERT INTO `master_bank` VALUES (17,'01','SOUTH INDIAN BANK','THANJAVUR','',NULL,NULL,NULL,NULL,NULL,NULL),(18,'02','BANK OF INDIA','THANJAVUR','',NULL,NULL,NULL,NULL,NULL,NULL),(19,'3SIB','SOUTH INDIAN BANK1','THANJAVUR','SCHOOL MT',NULL,NULL,NULL,NULL,NULL,NULL),(20,'03','BANK OF INDIA','KAUVERI NAGAR','THANJAVUR',NULL,NULL,NULL,NULL,NULL,NULL),(21,'04','BANK OF INDIA','KAUVERI NAGAR1','THANJAVUR',NULL,NULL,NULL,NULL,NULL,NULL),(22,'09','SOUTH INDIAN BANK4','THANJAVUR','PARISH ACCOUNT',NULL,NULL,NULL,NULL,NULL,NULL),(23,'05','BANK OF INDIA','KAUVERI NAGAR 2','SCHOOL - FEES',NULL,NULL,NULL,NULL,NULL,NULL),(24,'08','SOUTH INDIAN BANK 5','THANJAVUR','SCHOOL MISCELLANOUS 1',NULL,NULL,NULL,NULL,NULL,NULL),(38,'BK1','Axis Babk -83529','Deodurga','Deodurga','UTIB0001289','','',NULL,'',NULL),(39,'BK3','Axis Bank D B High School','Devadurga','Devadurga','','','',NULL,'',NULL),(40,'BK4','Axis Bank D B Primary School','Devadurga','Dod','','','',NULL,'',NULL),(41,'BK5','PRAGATHI GRAMIN BANK','Devadurga','','','','',NULL,'',NULL),(42,'BK7','STATE BANK OF HYDERABAD','Devadurga','','','','',NULL,'',NULL),(43,'BK8','INDIAN BANK - 460196270','Raichur','Raichur','','','',NULL,'',NULL),(44,'BK9','STATE BANK OF HYDRABAD - 62143314785','Deodurga','Deodurga','','','',NULL,'',NULL),(45,'BK10','Axis Bank - 1332','Deodurga','Deodurga','UTIB0001289','','',NULL,'',NULL),(46,'BK11','Axis Bank - 78080','Raichur','Raichur','','','',NULL,'',NULL),(47,'BK12','Axis Bank D B Society Loc','Devadurga','Devadurga','','','',NULL,'',NULL),(48,'BK13','INDIAN BANK','RAICHUR','RAICHUR','','','',NULL,'',NULL),(49,'BK14','INDIAN BANK - 1512','RAICHUR','RAICHUR','IDIB000R001','','',NULL,'',NULL),(50,'BK15','STATE BANK OF HYDRABAD','DEODURGA','DEODURGA','','','',NULL,'',NULL),(59,'','South Indian Bank','Nellore','','','','',NULL,'',NULL),(60,'BK7','Catholic Syrian Bank','Nellore','','','','',NULL,'',NULL),(61,'','Union Bank of India','Nellore','','','','',NULL,'',NULL),(62,'BK6','Bank of Baroda','Nellore','','','','',NULL,'',NULL);
...
CREATE TABLE `master_bank_account` (
  ...
  CONSTRAINT `FK_master_bank_bank_id` FOREIGN KEY (`BANK_ID`) REFERENCES `master_bank` (`BANK_ID`)
...
INSERT INTO `master_bank_account` VALUES (27,1157,'SIB1','52130-SIB1',NULL,1,17,'2009-04-01 00:00:00','2015-03-25 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(28,1158,'SIB2','4599-SIB2',NULL,1,17,'2009-04-01 00:00:00','2010-03-31 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(29,1159,'BOB1','182-BOB1',NULL,1,18,'2009-04-01 00:00:00','2015-03-25 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(30,1160,'008','761012809-008',NULL,1,17,'2009-09-25 00:00:00','2010-12-25 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(31,1161,'009','761012809-009',NULL,1,17,'2009-09-25 00:00:00','2010-12-25 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(32,1162,'010','761012809-010',NULL,1,17,'2009-09-25 00:00:00','2010-12-25 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(33,1163,'3SIB','56806-3SIB',NULL,1,19,'2011-04-01 00:00:00','2015-03-25 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(34,1164,'03','3388-03',NULL,1,20,'2010-02-15 00:00:00','2015-03-25 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(35,1165,'04','3364-04',NULL,1,21,'2010-02-04 00:00:00','2015-03-25 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(36,1166,'09','57978-09',NULL,1,22,'2011-03-28 00:00:00','2015-03-25 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(37,1167,'06','814310100000182-06',NULL,1,23,'2011-04-01 00:00:00','2015-03-25 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(38,1168,'4SIB','56806-4SIB',NULL,1,19,'2011-04-01 00:00:00','2015-03-25 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(39,1169,'08','007605300056806-08',NULL,1,24,'2011-04-01 00:00:00','2015-03-25 00:00:00',NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(79,1470,'BKA1','Axis Babk -83529','',1,38,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(80,1471,'BKA3','Axis Bank D B High School','',1,39,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(81,1472,'BKA4','Axis Bank D B Primary School','',1,40,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(82,1473,'BKA5','PRAGATHI GRAMIN BANK','',1,41,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(83,1474,'BKA7','STATE BANK OF HYDERABAD','',1,42,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(84,1475,'BKA8','INDIAN BANK - 460196270','',1,43,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(85,1476,'BKA9','STATE BANK OF HYDRABAD - 62143314785','',1,44,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(86,1477,'BKA10','Axis Bank - 1332','',1,45,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(87,1478,'BKA11','Axis Bank - 78080','',1,46,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(88,1479,'BKA12','Axis Bank D B Society Loc','',1,47,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(89,1486,'BKA13','INDIAN BANK','',1,48,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(90,1487,'BKA14','INDIAN BANK - 1512','',1,49,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(91,1488,'BKA15','STATE BANK OF HYDRABAD','',1,50,'2011-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(102,1785,'','0381053000002155','',1,59,'2008-03-28 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(103,1786,'','021001549517190001','',1,60,'2005-09-09 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(104,1787,'','330602010920389','',1,61,'2007-06-15 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(105,1788,'','09800100007457','',1,62,'2012-04-01 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0),(106,1789,'','09800100007320','',1,62,'1985-01-24 00:00:00',NULL,NULL,0,0,0,0.00,NULL,NULL,0.00,0,0);
...
INSERT INTO `master_cost_centre` VALUES (6,NULL,'Education & Nutrition Programme',NULL),(7,NULL,'Deodurga Church',NULL),(8,NULL,'Pastoral Project',NULL),(9,NULL,'Mobile Clinic Project - BREADS',NULL),(10,NULL,'NCLP',NULL),(29,NULL,'Milk',NULL),(30,NULL,'Internet',NULL),(31,NULL,'Fruits , Vegetables, other Provissions',NULL),(32,NULL,'Cake & Sweets Etc..',NULL),(33,NULL,'Rice',NULL),(34,NULL,'Snacks',NULL),(35,NULL,'Gas & Fule',NULL),(36,NULL,'Meet Egg & Fish',NULL),(37,NULL,'Telephone',NULL);
...
INSERT INTO `master_cost_centre_category` VALUES (1,'Primary'),(3,'Primary Cost Category');
...
INSERT INTO `master_donaud` VALUES (11,'Signora Theresa',1,'','',131,'','','','',0,'',NULL,'',NULL,NULL,'',0,0,NULL,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(12,'PROPAGANDHA FIDE ROME',1,'ROME','',131,'','','','',0,'',NULL,'',NULL,NULL,'',0,0,NULL,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(13,'Suore Bethlemite',1,'Piazza Sabazio','',131,'','','','',0,'',NULL,'',NULL,NULL,'',0,0,NULL,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(14,'Miracle foundation',1,'','',138,'','','','',0,'',NULL,'',NULL,NULL,'',0,0,NULL,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(15,'HOLY CROSS MINISTRY',1,'','',56,'','','','',0,'',NULL,'',NULL,NULL,'',0,0,NULL,0,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,0,'0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `master_donaud_ins_type` VALUES (1,'School'),(2,'College'),(3,'Non-Government Organization'),(4,'Corporate'),(5,'Religious Community'),(6,'Parish');
...
CREATE TABLE `master_executive_committee` (
  ...
  CONSTRAINT `FK_STATE_ID` FOREIGN KEY (`STATE_ID`) REFERENCES `master_state` (`STATE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `master_insti_perference` VALUES (1,NULL,'SAGAYAMATHA SOCIAL SERVICE SOCIETY','','','Madhakotai',NULL,128,'','','','','','KAM/240/K/74','2015-11-20 00:00:00','','2015-11-20 00:00:00','','','','','3',3,'','','','2015-11-20 00:00:00','',0,NULL);
...
INSERT INTO `master_project_catogory` VALUES (5,'Community'),(15,'House'),(7,'Parish'),(4,'Primary'),(16,'Projects'),(14,'Province'),(6,'School');
...
INSERT INTO `master_setting` VALUES ('Country','9',1),('Currency','à¤°',1),('CurrencyCode','',1),('CurrencyCodePosition','',1),('CurrencyNegativePattern','14',1),('CurrencyNegativeSign','( )',1),('CurrencyPosition','Before',1),('CurrencyPositivePattern','2',1),('DecimalPlaces','2',1),('DecimalSeparator','.',1),('DigitGrouping','3,3,3',1),('EnableTransMode','0',1),('GroupingSeparator',',',1),('HighNaturedAmt','500',1),('Location','Primary',1),('PrintVoucher','0',1),('TDSEnabled','0',1),('TransEntryMethod','1',1),('UIDateFormat','dd/MM/yyyy',1),('UIDateSeparator','/',1),('UIFilterMode','Starts',1),('UIForeignBankAccount','',1),('UILanguage','en-US',1),('UIProjSelection','1',1),('UIThemes','Office 2010 Silver',1),('UITransClose','1',1),('UITransMode','2',1),('UITransType','Codeless',1);
...
INSERT INTO `master_state` VALUES (37,'Tamil Nadu',NULL);
...
INSERT INTO `master_voucher` VALUES (1,'Receipts',1,2,'','',0,0,0,'3',1,0,'',0),(2,'Payments',2,1,'','',1,2,0,'3',12,0,'',0),(3,'Contra',3,1,'','',1,2,0,'January',1,0,'',0),(4,'Journal',4,1,'','',1,2,0,'January',1,0,'',0);
...
INSERT INTO `portal_datasyn_message` VALUES (12,'2015-09-29 13:07:11','CLOSED','2015-09-29 13:08:50','2015-09-29 13:09:03','Data Synchronized Successfully.',0,'2015-11-20 10:22:54','2015-04-01 00:00:00','2015-09-29 00:00:00'),(13,'2015-09-29 13:13:05','CLOSED','2015-09-29 13:14:50','2015-09-29 13:14:51','Data Synchronized Successfully.',0,'2015-11-20 10:22:54','2014-04-01 00:00:00','2014-08-31 00:00:00'),(14,'2015-09-29 13:19:56','CLOSED','2015-09-29 13:20:50','2015-09-29 13:20:57','Data Synchronized Successfully.',0,'2015-11-20 10:22:54','2014-04-01 00:00:00','2014-04-30 00:00:00'),(15,'2015-10-06 14:54:00','CLOSED','2015-10-06 14:55:11','2015-10-06 14:55:14','Data Synchronized Successfully.',0,'2015-11-20 10:22:54','2015-07-01 00:00:00','2015-08-31 00:00:00'),(16,'2015-10-14 12:46:41','FAILED','2015-10-14 12:49:31',NULL,'Problem in Importing Vouchers. Parameter \'?NAME\' must be defined.',0,'2015-11-20 10:22:54','2015-04-01 00:00:00','2015-10-14 00:00:00'),(17,'2015-10-15 15:39:04','CLOSED','2015-10-15 15:41:30','2015-10-15 15:41:33','Data Synchronized Successfully.',0,'2015-11-20 10:22:54','2015-04-01 00:00:00','2015-04-30 00:00:00'),(18,'2015-10-15 17:14:56','CLOSED','2015-10-15 17:17:30','2015-10-15 17:17:33','Data Synchronized Successfully.',0,'2015-11-20 10:22:54','2015-09-01 00:00:00','2015-09-30 00:00:00'),(19,'2015-10-16 13:16:49','CLOSED','2015-10-16 13:17:33','2015-10-16 13:18:14','Data Synchronized Successfully.',0,'2015-11-20 10:22:54','2015-04-01 00:00:00','2015-09-30 00:00:00'),(20,'2015-10-23 11:13:05','CLOSED','2015-10-23 11:24:34','2015-10-23 11:30:29','Data Synchronized Successfully.',0,'2015-11-20 10:22:54','2015-04-01 00:00:00','2015-10-23 00:00:00'),(21,'2015-11-03 15:47:51','FAILED','2015-11-03 15:49:54',NULL,'Problem in Importing Vouchers. Exception in importing Master Ledger Group. System.ArgumentException: Column \'ParentGroup\' does not belong to table LedgerGroup.\r\n   at System.Data.DataRow.GetDataColumn(String columnName)\r\n   at System.Data.DataRow.get_Item(String columnName)\r\n   at AcMEDSync.Model.ImportVoucherSystem.ImportMasterLedgerGroup()',0,'2015-11-20 10:22:54','2015-04-01 00:00:00','2015-10-31 00:00:00'),(22,'2015-11-20 10:22:22','RECEIVED',NULL,NULL,'File Scheduled for DataSync',0,'2015-11-20 10:22:54',NULL,NULL);
...
CREATE TABLE `project_costcentre` (
  ...
  CONSTRAINT `FK_PROJECT_COSTCENTRE_MAPPING` FOREIGN KEY (`PROJECT_ID`) REFERENCES `master_project` (`PROJECT_ID`),
  CONSTRAINT `FK_PROJECT_COSTCENTRE_MAPPING_COST_CENTRE` FOREIGN KEY (`COST_CENTRE_ID`) REFERENCES `master_cost_centre` (`COST_CENTRE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `project_ledger` (
  ...
  CONSTRAINT `FK_MASTER_LEDGER_LEDGERID` FOREIGN KEY (`LEDGER_ID`) REFERENCES `master_ledger` (`LEDGER_ID`),
  CONSTRAINT `PROJECT_ID` FOREIGN KEY (`PROJECT_ID`) REFERENCES `master_project` (`PROJECT_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `project_voucher` (
  ...
  CONSTRAINT `FK_MASTER_PROJECT_ID` FOREIGN KEY (`PROJECT_ID`) REFERENCES `master_project` (`PROJECT_ID`),
...
INSERT INTO `user_info` VALUES (1,'Admin','Admin','admin','1uHL2oMM9bq8iOYovzJfbQ==','Admin',0,NULL,NULL,NULL,NULL,1,1,'','0000-00-00 00:00:00','','0000-00-00 00:00:00',NULL),(4,'',NULL,'Supervisor','jAxSbs?','Supervisor',0,NULL,NULL,NULL,NULL,0,1,'','0000-00-00 00:00:00','','0000-00-00 00:00:00',NULL);
...
CREATE TABLE `user_rights` (
  ...
  CONSTRAINT `FK_user_rights_ActivityId` FOREIGN KEY (`ACTIVITY_ID`) REFERENCES `activitiy_rights` (`ACTIVITY_ID`),
...
CREATE TABLE `voucher_cc_trans` (
  ...
  CONSTRAINT `FK_voucher_cost_centre_voucher_ID` FOREIGN KEY (`VOUCHER_ID`) REFERENCES `voucher_master_trans` (`VOUCHER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=27711 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `voucher_number_format` VALUES (1,2,'05',5,'','1',1,1,2015,6),(3,2,'06',6,'','1',4,1,2014,6),(4,2,'08',8,'','1',5,1,2014,6),(5,2,'10',10,'','1',6,1,2014,6),(6,2,'08',8,'','1',7,1,2014,6),(7,2,'06',6,'','1',8,1,2014,6),(8,2,'07',7,'','1',9,1,2014,6),(9,2,'10',10,'','1',10,1,2014,6),(10,2,'07',7,'','1',11,1,2014,6),(11,2,'08',8,'','1',12,1,2014,6),(12,2,'60',60,'','1',4,1,2014,4),(13,2,'150',150,'','1',5,1,2014,4),(14,2,'51',51,'','1',6,1,2014,4),(15,2,'43',43,'','1',7,1,2014,4),(16,2,'42',42,'','1',8,1,2014,4),(17,2,'51',51,'','1',9,1,2014,4),(18,2,'42',42,'','1',10,1,2014,4),(19,2,'36',36,'','1',11,1,2014,4),(20,2,'72',72,'','1',12,1,2014,4),(21,2,'32',32,'','1',1,1,2015,4),(22,2,'01',1,'','1',4,1,2014,2),(23,2,'01',1,'','1',5,1,2014,2),(24,2,'05',5,'','1',6,1,2014,2),(25,2,'04',4,'','1',7,1,2014,2),(26,2,'02',2,'','1',8,1,2014,2),(27,2,'02',2,'','1',9,1,2014,2),(28,2,'02',2,'','1',10,1,2014,2),(29,2,'03',3,'','1',12,1,2014,2),(30,2,'01',1,'','1',4,1,2014,1),(31,2,'04',4,'','1',6,1,2014,1),(32,2,'04',4,'','1',7,1,2014,1),(33,2,'05',5,'','1',9,1,2014,1),(34,2,'01',1,'','1',11,1,2014,1),(35,2,'01',1,'','1',8,1,2014,7),(36,2,'01',1,'','1',9,1,2014,7),(37,2,'01',1,'','1',10,1,2014,7),(38,2,'01',1,'','1',12,1,2014,7),(48,3,'02',2,'','1',4,1,2014,6),(49,3,'01',1,'','1',5,1,2014,6),(50,3,'02',2,'','1',6,1,2014,6),(51,3,'01',1,'','1',7,1,2014,6),(52,3,'01',1,'','1',8,1,2014,6),(53,3,'02',2,'','1',9,1,2014,6),(54,3,'02',2,'','1',10,1,2014,6),(55,3,'02',2,'','1',11,1,2014,6),(56,3,'03',3,'','1',12,1,2014,6),(57,3,'01',1,'','1',1,1,2015,6),(63,3,'01',1,'','1',5,1,2014,7),(64,3,'01',1,'','1',7,1,2014,7),(65,3,'01',1,'','1',8,1,2014,7),(76,3,'01',1,'','1',7,1,2014,4),(77,3,'01',1,'','1',8,1,2014,4),(87,3,'02',2,'','1',4,1,2014,2),(88,3,'01',1,'','1',5,1,2014,2),(89,3,'08',8,'','1',6,1,2014,2),(90,3,'06',6,'','1',7,1,2014,2),(91,3,'03',3,'','1',8,1,2014,2),(92,3,'04',4,'','1',9,1,2014,2),(93,3,'05',5,'','1',10,1,2014,2),(94,3,'02',2,'','1',11,1,2014,2),(95,3,'04',4,'','1',12,1,2014,2),(104,3,'03',3,'','1',4,1,2014,1),(105,3,'02',2,'','1',5,1,2014,1),(106,3,'04',4,'','1',6,1,2014,1),(107,3,'01',1,'','1',7,1,2014,1),(108,3,'02',2,'','1',8,1,2014,1),(109,3,'05',5,'','1',9,1,2014,1),(110,3,'01',1,'','1',10,1,2014,1),(111,3,'02',2,'','1',11,1,2014,1),(112,2,'01',1,'','1',1,1,2015,7),(113,3,'01',1,'','1',1,1,2015,1),(114,2,'01',1,'','1',2,1,2015,6),(116,3,'01',1,'','1',2,1,2015,2),(117,2,'01',1,'','1',2,1,2015,2),(118,3,'02',2,'','1',1,1,2015,2),(120,2,'04',4,'','1',1,1,2015,2),(129,1,'30',30,'','4',4,12,2014,7),(130,1,'1360',1360,'','4',4,12,2014,6),(131,1,'339',339,'','4',4,12,2014,4),(132,1,'287',287,'','4',4,12,2014,2),(133,1,'175',175,'','4',4,12,2014,1),(242,3,'01',1,'','1',3,1,2015,20),(310,3,'02',2,'','1',3,1,2015,21),(369,1,'396',396,'','4',4,12,2014,18),(372,3,'01',1,'','1',3,1,2015,15),(376,3,'03',3,'','1',3,1,2015,16),(623,3,'02',2,'','1',4,1,2015,20),(658,3,'04',4,'','1',4,1,2015,15),(670,3,'02',2,'','1',4,1,2015,16),(853,3,'01',1,'','1',5,1,2015,15),(855,3,'02',2,'','1',5,1,2015,20),(873,3,'01',1,'','1',5,1,2015,16),(926,1,'54',54,'','4',4,12,2014,21),(938,1,'339',339,'','4',4,12,2014,16),(952,1,'218',218,'','4',4,12,2014,15),(970,1,'1583',1583,'','4',4,12,2014,20),(1051,3,'01',1,'','1',6,1,2015,20),(1149,3,'01',1,'','1',7,1,2015,20),(1154,3,'01',1,'','1',6,1,2015,21),(1252,3,'05',5,'','1',6,1,2015,15),(1285,3,'06',6,'','1',6,1,2015,16),(1398,3,'01',1,'','1',7,1,2015,21),(1591,3,'02',2,'','1',7,1,2015,15),(1699,3,'06',6,'','1',7,1,2015,16),(1713,3,'01',1,'','1',8,1,2015,20),(1751,3,'01',1,'','1',9,1,2015,20),(1755,3,'01',1,'','1',8,1,2015,15),(1862,3,'01',1,'','1',8,1,2015,16),(1868,3,'02',2,'','1',9,1,2015,16),(2011,3,'01',1,'','1',9,1,2015,15),(2772,1,'15',15,'','4',4,12,2015,21),(2954,3,'01',1,'','1',10,1,2015,20),(3176,1,'851',851,'','4',4,12,2015,20),(3213,1,'190',190,'','4',4,12,2015,15),(3214,3,'03',3,'','1',10,1,2015,15),(3229,3,'05',5,'','1',10,1,2015,16),(3232,1,'180',180,'','4',4,12,2015,16),(3233,1,'261',261,'','4',4,12,2015,18);
...
CREATE TABLE `voucher_trans` (
  ...
  PRIMARY KEY (`VOUCHER_ID`,`SEQUENCE_NO`,`BRANCH_ID`),
  KEY `LEDGER_ID` (`LEDGER_ID`),
  CONSTRAINT `FK_MASTER_LEDGER_LEDGER_ID` FOREIGN KEY (`LEDGER_ID`) REFERENCES `master_ledger` (`LEDGER_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-04-05 11:05:05
