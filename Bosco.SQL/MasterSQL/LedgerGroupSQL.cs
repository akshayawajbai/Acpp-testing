        ...
        private string GetLedgerGroupSQL()
        {
            ...
            switch (sqlCommandId)
            {
                case SQLCommand.LedgerGroup.Add:
                    {
                        // 17/02/2026, added DISPLAY_LEDGER_GROUP for second-level language (e.g. French)
                        query = "INSERT INTO MASTER_LEDGER_GROUP ( " +
                                   "GROUP_CODE, " +
                                   "LEDGER_GROUP, " +
                                   "DISPLAY_LEDGER_GROUP, " +
                                   "PARENT_GROUP_ID, " +
                                   "NATURE_ID, " +
                ...
                case SQLCommand.LedgerGroup.Update:
                    {
                        ...
                        query = "UPDATE MASTER_LEDGER_GROUP SET " +
                                        ...
                                        "DISPLAY_LEDGER_GROUP =?DISPLAY_LEDGER_GROUP, " +
                ...
                case SQLCommand.LedgerGroup.FetchAll:
                    {
                        query = "SELECT " +
                                   ...
                                   //bharath 18/02/2026 language update
                                    "IFNULL(CASE WHEN ?DISPLAY_INPUT_LAN = 1 THEN DISPLAY_LEDGER_GROUP ELSE LEDGER_GROUP END, LEDGER_GROUP) AS 'Ledger Group' , " +
                ...
                case SQLCommand.LedgerGroup.FetchLedgerList:
                    {
                        ...
                        query = "SELECT ML.LEDGER_CODE, " +
                            //"ML.LEDGER_NAME AS 'LEDGER NAME'\n" +
                            //bharath 18/02/2026 language update
                            "IFNULL(CASE WHEN ?DISPLAY_INPUT_LAN = 1 THEN ML.DISPLAY_LEDGER_NAME ELSE ML.LEDGER_NAME END, ML.LEDGER_NAME) AS 'LEDGER NAME'\n" +
