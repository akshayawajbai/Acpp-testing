    ...
    public class ProjectCatogory : IDatabaseQuery
    {
        ...
        private string GetProjectCatogorySQL()
        {
            ...
            switch (sqlCommandId)
            {
                ...
                case SQLCommand.ProjectCatogory.ChangeProjectCategoryNameInMaster:
                    {
                        query = "UPDATE MASTER_PROJECT_CATOGORY SET PROJECT_CATOGORY_NAME = ?PROJECT_CATOGORY_NAME WHERE PROJECT_CATOGORY_NAME = ?OLD_PROJECT_CATOGORY_NAME;";
                        break;
                    }
