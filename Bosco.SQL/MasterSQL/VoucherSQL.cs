            ...
            switch (sqlQueryType)
            {
                ...
                case SQLCommand.Voucher.Add:
                    Query = "INSERT INTO MASTER_VOUCHER" +
                            "(" +
                                 ...
                                 "IS_PAN_ENABLED,IS_GST_ENABLED" + //bharath 04/06/2026 Ledger PAN and GST set
                            ")" +
                            " VALUES" +
                            "(" +
                                 "?VOUCHER_NAME," +
                ...
                case SQLCommand.Voucher.FetchByVoucherId:
                    Query = "SELECT "
                                    ...
                                    + "DURATION,"
                                    + "ALLOW_DUPLICATE,"
                                    + "NOTE,IS_NARRATION_ENABLED,IS_PAN_ENABLED,IS_GST_ENABLED " //bharath 04/06/2026 Ledger PAN and GST set
                             + " FROM MASTER_VOUCHER"
                                  + " WHERE VOUCHER_ID=?VOUCHER_ID";
                    break;
