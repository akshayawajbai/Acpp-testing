    ...
    public class ExportVouchersSQL : IDatabaseQuery
    {
        ...
        private string GetExportVoucherQuery()
        {
            ...
            switch (sqlCommandId)
            {
                ...
                case SQLCommand.ExportVouchers.FetchVoucherTransactions:
                    {
                        ...
                        query = "SELECT MT.VOUCHER_ID,\n" +
                                ...
                                "       MHL.LEDGER_NAME,\n" +
                                "       VT.AMOUNT AS AMOUNT,\n" +
                                "       VT.LIVE_EXCHANGE_RATE,VT.EXCHANGE_RATE,VT.ACTUAL_AMOUNT,\n" +
                                "       VT.TRANS_MODE,\n" +
                                "       VT.CHEQUE_NO,\n" +
                                "       VT.MATERIALIZED_ON,\n" +
                                "       VT.CHEQUE_REF_DATE,\n" +
                                "       VT.CHEQUE_REF_BANKNAME,\n" +
                                "       VT.CHEQUE_REF_BRANCH,VT.FUND_TRANSFER_TYPE_NAME, 'GST0' AS SLAB, VT.LEDGER_GST_CLASS_ID,VT.GST,VT.CGST,VT.SGST,VT.IGST,VT.NARRATION, MT.IS_MULTI_CURRENCY,MT.IS_CASH_BANK_STATUS\n" +
                                "  FROM VOUCHER_MASTER_TRANS MT\n" +
                        ...
                        //        "       IF(MHL.LEDGER_NAME IS NOT NULL, MHL.LEDGER_NAME, ML.LEDGER_NAME) AS LEDGER_NAME,\n" +
                        //        "       MHL.LEDGER_NAME,\n" +
                        //        "       MT.CONTRIBUTION_AMOUNT,MT.CURRENCY_COUNTRY_ID,MT.EXCHANGE_RATE,MT.EXCHANGE_COUNTRY_ID,\n" +
                        //        "       (VT.AMOUNT * IF(MT.IS_MULTI_CURRENCY=1, VT.EXCHANGE_RATE, 1)) CALCULATED_AMOUNT,\n" +
                ...
                case SQLCommand.ExportVouchers.FetchBankDetails:
                    {
                        ...
                        query = "SELECT *\n" +
                                            ...
                                            "                OPERATED_BY,\n" +
                                            "                IS_FCRA_ACCOUNT,\n" +
                                            "                MC.COUNTRY AS CURRENCY_COUNTRY, ML.OP_EXCHANGE_RATE\n" +
                                            "           FROM LEDGER_BALANCE LB\n" +
                                            "          INNER JOIN MASTER_LEDGER ML\n" +
                                            "             ON ML.LEDGER_ID = LB.LEDGER_ID\n" +
                                            "          INNER JOIN MASTER_BANK_ACCOUNT MBA\n" +
                            ...
                            //  "            AND LB.AMOUNT > 0\n" +
                                            ...
                                            "                '' AS OPERATED_BY,\n" +
                                            "                '' AS IS_FCRA_ACCOUNT,\n" +
                                            "                '' AS CURRENCY_COUNTRY, '' AS OP_EXCHANGE_RATE\n" +
                                            "           FROM FD_ACCOUNT FA\n" +
                                            "          INNER JOIN MASTER_BANK MB\n" +
                ...
                case SQLCommand.ExportVouchers.FetchLedgerBalance:
                    {
                        ...
                        query = "SELECT MP.PROJECT,\n" +
                            ...
                            //"       TRANS_MODE,\n" + 
                                ...
                                "       END AS TRANS_MODE, \n" +
                                  "     CASE WHEN COUNT(*) <= 1 THEN TRANS_FC_MODE\n" +
                                "       ELSE\n" +
                                "           IF( SUM(IF(TRANS_MODE='CR', AMOUNT, -AMOUNT))<0, 'DR', 'CR')\n" +
                                "       END AS TRANS_FC_MODE, \n" +
                                "       TRANS_FLAG\n" +
                                "  FROM LEDGER_BALANCE LB\n" +
                                "  LEFT JOIN MASTER_PROJECT MP\n" +
                ...
                case SQLCommand.ExportVouchers.FetchCountryCurrencyExchangeRate:
                    {
                        query = "SELECT MC.COUNTRY, MCCER.APPLICABLE_FROM, MCCER.APPLICABLE_TO, MCCER.EXCHANGE_RATE\n" +
                                " FROM MASTER_COUNTRY_CURRENCY_EXCHANGE_RATE MCCER LEFT JOIN MASTER_COUNTRY MC ON MC.COUNTRY_ID = MCCER.COUNTRY_ID";
                        break;
                    }
                ...
                case SQLCommand.ExportVouchers.FetchHeadOfficeLedger:
                    {
                        ...
                        query = "SELECT T.LEDGER_CODE,\n" +
                              ...
                              "       T.BUDGET_GROUP_ID, T.BUDGET_SUB_GROUP_ID, T.COUNTRY_ID, T.COUNTRY AS CURRENCY_COUNTRY, T.OP_EXCHANGE_RATE\n" +
                              "  FROM ((SELECT ML.LEDGER_CODE,\n" +
                ...
                case SQLCommand.ExportVouchers.FDAccounts:
                    {
                        query = "SELECT FDA.FD_ACCOUNT_ID,\n" +
                                ...
                                "       FDA.STATUS,\n" +
                                "       FDA.FD_STATUS,\n" +
                                "       FDA.FD_SUB_TYPES,MF_FOLIO_NO,MF_SCHEME_NAME,MF_NAV_PER_UNIT,MF_NO_OF_UNITS,MF_MODE_OF_HOLDING,\n" +
                                "       FDA.NOTES,\n" +
                                ...
                                "    ON MB.BANK_ID = FDA.BANK_ID\n" +
                                "   LEFT JOIN MASTER_COUNTRY ME\n" +
                                "   ON ME.COUNTRY_ID = FDA.CURRENCY_COUNTRY_ID\n" +
                ...
                case SQLCommand.ExportVouchers.FDVoucherMasterTrans:
                    {
                        query = "SELECT VOUCHER_ID,\n" +
                                ...
                                "       CALCULATED_AMOUNT,\n" +
                                "       ACTUAL_AMOUNT,\n" +
                                "       NAME_ADDRESS,VMT.IS_MULTI_CURRENCY,VMT.IS_CASH_BANK_STATUS\n" +
                                "  FROM VOUCHER_MASTER_TRANS VMT\n" +
                                "   LEFT JOIN MASTER_COUNTRY ME\n" +
                                "    ON ME.COUNTRY_ID = VMT.CURRENCY_COUNTRY_ID\n" +
                                "  LEFT JOIN MASTER_PROJECT MP\n" +
                                "    ON VMT.PROJECT_ID = MP.PROJECT_ID\n" +
