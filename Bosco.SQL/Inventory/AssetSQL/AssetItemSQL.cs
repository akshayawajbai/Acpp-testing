    ...
    public class AssetItemSQL : IDatabaseQuery
    {
        ...
        public string GetgroupSQL()
        {
            ...
            switch (SqlcommandId)
            {
                ...
                case SQLCommand.AssetItem.FetchAssetandLedger:
                    {
                        //query =
                        //    "SELECT DISTINCT " +
                        //    "    AI.ITEM_ID AS ITEM_ID, " +
                        //    "    1 AS ITEM_TYPE, " +
                        //    "    CONCAT(AI.ASSET_ITEM, ' - ', AG.ASSET_CLASS) AS ASSET_ITEM, " +
                        //    "    AG.ASSET_CLASS_ID, " +
                        //    "    AG.ASSET_CLASS AS ASSET_GROUP, " +
                        //    "    IF(PARENT.ASSET_CLASS = 'Primary', AG.ASSET_CLASS, PARENT.ASSET_CLASS) AS PARENT_CLASS, " +
                        //    "    AU.SYMBOL, " +
                        ...
                        //    "    NULL AS LOCATION_ID " +
                        //    "FROM ASSET_ITEM AI " +
                        //    "INNER JOIN ASSET_CLASS AG ON AG.ASSET_CLASS_ID = AI.ASSET_CLASS_ID " +
                        //    "INNER JOIN ASSET_CLASS PARENT ON AG.PARENT_CLASS_ID = PARENT.ASSET_CLASS_ID " +
                        //    "INNER JOIN UOM AU ON AU.UOM_ID = AI.UOM_ID " +
                        //    "INNER JOIN MASTER_LEDGER AL ON AL.LEDGER_ID = AI.ACCOUNT_LEDGER_ID " +

                        //    "UNION ALL " +

                        //    "SELECT DISTINCT " +
                        //    "    ML.LEDGER_ID AS ITEM_ID, " +
                        //    "    2 AS ITEM_TYPE, " +
                        //    "    CONCAT(ML.LEDGER_NAME, ' - ', MP.LEDGER_GROUP) AS ASSET_ITEM, " +
                        //    "    ML.GROUP_ID, " +
                        //    "    MP.LEDGER_GROUP, " +
                        //    "    NULL AS PARENT_CLASS, " +
                        //    "    NULL AS SYMBOL, " +
                        //    "    NULL AS PREFIXSUFFIX, " +
                        //    "    NULL AS PREFIX, " +
                        //    "    NULL AS SUFFIX, " +
                        //    "    NULL AS RETENTION_YRS, " +
                        //    "    NULL AS DEPRECIATION_YRS, " +
                        //    "    NULL AS IS_INSURANCE, " +
                        //    "    NULL AS IS_AMC, " +
                        //    "    NULL AS STARTING_NO, " +
                        //    "    NULL AS WIDTH, " +
                        //    "    ML.LEDGER_ID AS ACCOUNT_LEDGER_ID, " +
                        //    "    ML.LEDGER_NAME AS ACCOUNT_LEDGER, " +
                        //    "    NULL AS LOCATION_ID " +
                        ...
                        //    "INNER JOIN MASTER_LEDGER_GROUP MP ON ML.GROUP_ID = MP.GROUP_ID " +
                        //    "WHERE ML.STATUS = 0 " +
                        //    "  AND ML.LEDGER_TYPE = 'GN' " +
                        //    "  AND ML.GROUP_ID <> 8 " +
                        //    "  AND MP.LEDGER_GROUP <> 'Bank Accounts'" +
                        //    "  AND PL.PROJECT_ID = ?PROJECT_ID " +
                        //    "ORDER BY ASSET_ITEM ASC;";
                        break;
                    }
