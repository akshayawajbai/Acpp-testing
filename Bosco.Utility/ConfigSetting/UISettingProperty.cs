...
namespace Bosco.Utility.ConfigSetting
{
    public class UISettingProperty : TransProperty
    {
        ...
        //bharath for sdbinm and pdo default EnableSingleMode
        public string EnableSingleMode
        {
            get
            {
                return GetUISettingInfo(Setting.EnableSingleMode.ToString());
            }
        }
        ...
        //bharath for sdbinm and pdo default EnableSingleMode
        public string UIEnableSingleMode
        {
            get
            {
                return GetUISettingInfo(UserSetting.EnableSingleMode.ToString());
            }
        }
