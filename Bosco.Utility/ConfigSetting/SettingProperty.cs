...
namespace Bosco.Utility.ConfigSetting
{
    public class SettingProperty : UISettingProperty
    {
        ...
        public static string Enforce_Single_Mode_FY = "01/04/2026";
        ...
        public string MgnLocation
        {
            ...
            set
            {
                SettingProperty.ThirdPartyLocation = value;
            }
        }
        ...
        public int AuditorRights
        {
            get { return auditorRights; }
            set { auditorRights = value; }
        }
        ...
        private bool IsIbsgyc
        {
            get
            {
                return Bosco.Utility.ConfigSetting.SettingProperty.Current.IS_IB_SGYC;
            }
        }
        /// <summary>
        ...
        public bool IS_SDBANG
        {
            get
            {
                return headofficecode.ToUpper() == "SDBANG";
            }
        }

        public bool IS_SDBAFE
        {
            get
            {
                return headofficecode.ToUpper() == "SDBAFE";
            }
        }

        public bool IS_BSGRMG
        {
            get
            {
                return headofficecode.ToUpper() == "BSGRMG";
            }
        }

        public bool IS_SDB_PDO
        {
            get
            {
                return headofficecode.ToUpper() == "INMPDO";
            }
        }


        public bool IS_BSG_ESP
        {
            get
            {
                return headofficecode.ToUpper() == "BSGESP";
            }
        }

        public bool IS_IB_SGYC
        {
            get
            {
                return headofficecode.ToUpper() == "IBSGYC"; //ibsgyc
            }
        }
        ...
        public bool IS_HAESST
        {
            get
            {
                return headofficecode.ToUpper() == "HAESST";
            }
        }
        ...
        public bool IS_SDBAOS
        {
            get
            {
                return headofficecode.ToUpper() == "SDBAOS";
            }
        }
        public bool IS_SAB
        {
            get
            {
                return headofficecode.ToUpper().Substring(0, 3) == "SAB";
            }
        }
        /// <summary>
        ...
        public int IsLicenseModel
        {
            get
            {
                ...
                if (islicensemodel == 1)
                {
                    ...
                    if (DateSet.ToDate(licenseKeyGeneratedDate, false) < DateSet.ToDate("01/04/2017", false) || IS_SDB_CONGREGATION)
                    {
                        islicensemodel = 0;
                    }
                }
        ...
        //bharath 27/11/2025 for sdbinm and pdo default PAN and GST show
        ...
        public string EnablePANandAddressAleretMsg  //Added By Dinesh
        {
            get
            {
                ...
                string value = GetSettingInfo(FinanceSetting.EnablePANandAddresAlrteMesg.ToString());
        ...
        // 04/02/2026 - fallback to user setting DisplayInputLan for non-admin (same pattern as UILanguage: use GetUISettingInfo once base has it protected + DisplayInputLan)
        public string DisplayInputLanguage
        {
            get
            {
                string displayLanInput = GetSettingInfo(Setting.DisplayInputLanguage.ToString());

                displayLanInput = string.IsNullOrEmpty(displayLanInput) ? "0" : displayLanInput;
                return displayLanInput;
            }
        }
