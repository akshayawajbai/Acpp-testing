...
namespace Bosco.Utility.ConfigSetting
{
    public class UserProperty : SettingProperty
    {
        ...
        public bool IsFullRightsReservedUser
        {
            get
            {
                // 25/06/2026: Keep full-rights user behavior independent from AuditorRights.
                // Purpose: prevent menu visibility regressions; auditor lock is handled in frmBase/CommonMethod.
