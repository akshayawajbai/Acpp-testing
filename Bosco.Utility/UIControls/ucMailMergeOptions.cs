...
namespace ACPP.Modules.UIControls
{
    public partial class ucMailMergeOptions : UserControl
    {
        ...
        public BarItemVisibility VisiblePreviewMail
        {
            get { return bbiPreviewMail.Visibility; }
            set { bbiPreviewMail.Visibility = value; }
        }

        public BarItemVisibility VisiblePreviewSMS
        {
            get { return bbiPreviewSMS.Visibility; }
            set { bbiPreviewSMS.Visibility = value; }
        }
