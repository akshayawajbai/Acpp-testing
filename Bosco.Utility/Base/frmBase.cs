...
namespace Bosco.Utility.Base
{
    public class frmBase : DevExpress.XtraEditors.XtraForm
    {
        ...
        public bool IsAuditorViewOnlyMode()
        {
            return CommonMethod.IsAuditorViewOnlyMode();
        }

        public void ApplyAuditorRights(ucToolBar ucToolBar)
        {
            ...
            ucToolBar.VisibleAddButton = DevExpress.XtraBars.BarItemVisibility.Never;
            ucToolBar.VisibleEditButton = DevExpress.XtraBars.BarItemVisibility.Never;
            ucToolBar.VisibleDeleteButton = DevExpress.XtraBars.BarItemVisibility.Never;
            ucToolBar.VisibleMoveTrans = DevExpress.XtraBars.BarItemVisibility.Never;
            ucToolBar.VisbleInsertVoucher = DevExpress.XtraBars.BarItemVisibility.Never;
            ucToolBar.VisibleDownloadExcel = DevExpress.XtraBars.BarItemVisibility.Never;
            ucToolBar.VisibleRenew = DevExpress.XtraBars.BarItemVisibility.Never;
            ucToolBar.VisibleNegativeBalance = DevExpress.XtraBars.BarItemVisibility.Never;

            // 25/06/2026: Auditor mode allows view/print/navigation toolbar actions only.
            ucToolBar.VisiblePrintButton = DevExpress.XtraBars.BarItemVisibility.Always;
            ucToolBar.VisibleRefresh = DevExpress.XtraBars.BarItemVisibility.Always;
            ucToolBar.VisibleClose = DevExpress.XtraBars.BarItemVisibility.Always;
            ucToolBar.DisablePrintButton = true;
        ...
        public void ApplyUserRights(ucToolBar ucToolBar, List<Enum> userRights, int ParentId)
        {
            ...
            try
            {
                if (!this.LoginUser.IsFullRightsReservedUser || IsAuditorViewOnlyMode())
                {
