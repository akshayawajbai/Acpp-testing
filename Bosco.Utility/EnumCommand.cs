...
namespace Bosco.Utility
{
    ...
    public enum FinanceSetting
    {
        ...
        CustomizationForm,
        EnableTransMode,
        EnableSingleMode,  //bharath 23/07/2026
        UITransClose,
        UITransGSTPan,
        UITransMode,
        TransEntryMethod,
    ...
    public enum LedgerOptions
    {
        ...
        EnableGSTLedger,
        [Description("Enable Province % Ledgers")] //Added By Dinesh 18-05-2026
        EnableProvinceLedger
