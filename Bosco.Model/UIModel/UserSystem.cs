...
namespace Bosco.Model.UIModel
{
    public class UserSystem : SystemBase
    {
        ...
        //bharath 09/07/2026 
        public ResultArgs FetchChequeSettingforBankwise(string Bankname)
        {
            using (DataManager dataManager = new DataManager(SQLCommand.Setting.FetchChequeSettingforBankwise))
            {
                dataManager.Parameters.Add(this.AppSchema.ChequePrinting.DEFAULT_BANKColumn, Bankname);
                resultArgs = dataManager.FetchData(DataSource.DataTable);
            }
        ...
        public ResultArgs SaveChequeSetting(Int32 bankid, string bankFormat, string setting, string value)
        {
            using (DataManager dataManager = new DataManager(SQLCommand.Setting.InsertUpdateChequePrintingSetting))
            {
                ...
                //bharath 09/07/2026  
                dataManager.Parameters.Add(this.AppSchema.ChequePrinting.BANK_FORMATColumn, bankFormat);
