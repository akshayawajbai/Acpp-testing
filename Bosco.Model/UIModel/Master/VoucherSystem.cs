...
namespace Bosco.Model.UIModel.Master
{
    public class VoucherSystem : SystemBase
    {
        ...
        public int PanEnabled { get; set; }
        public int GSTEnabled { get; set; }
        ...
        public ResultArgs SaveVocherDetails()
        {
            using (DataManager dataManager = new DataManager(VoucherId.Equals(0) ? SQLCommand.Voucher.Add : SQLCommand.Voucher.Update))
            {
                ...
                //bharath 04/06/2026 Ledger PAN and GST set
                dataManager.Parameters.Add(this.AppSchema.Voucher.IS_PAN_ENABLEDColumn, PanEnabled);
                dataManager.Parameters.Add(this.AppSchema.Voucher.IS_GST_ENABLEDColumn, GSTEnabled);
        ...
        public void FillBankProperties()
        {
            ...
            if (dtVoucherEdit != null && dtVoucherEdit.Rows.Count > 0)
            {
                ...
                //bharath 04/06/2026 Ledger PAN and GST set
                PanEnabled = NumberSet.ToInteger(dtVoucherEdit.Rows[0][AppSchema.Voucher.IS_PAN_ENABLEDColumn.ColumnName].ToString());
                GSTEnabled = NumberSet.ToInteger(dtVoucherEdit.Rows[0][AppSchema.Voucher.IS_GST_ENABLEDColumn.ColumnName].ToString());
            }
        }
