...
namespace Bosco.Model
{
    public class AssetItemSystem : SystemBase
    {
        ...
        /// <summary>
        /// Fetch Asset and Ledger Details for the View Form. Dinesh 08-12-2025
        /// </summary>
        /// <returns></returns>
        public ResultArgs FetchAssetandledgerDetails()
        {
            using (DataManager dataManger = new DataManager(SQLCommand.AssetItem.FetchAssetandLedger))
            {
