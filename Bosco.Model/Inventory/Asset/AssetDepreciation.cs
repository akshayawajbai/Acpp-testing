                ...
                using (VoucherTransactionSystem voucherTransaction = new VoucherTransactionSystem())
                {
                    ...
                    if (this.AllowMultiCurrency == 1)
                    {
                        if (this.TransInfo != null)
                        {
                            ...
                            {
                                drv.BeginEdit();
                                drv[voucherTransaction.AppSchema.VoucherTransaction.EXCHANGE_RATEColumn.ColumnName] = 1;
                                drv[voucherTransaction.AppSchema.VoucherTransaction.LIVE_EXCHANGE_RATEColumn.ColumnName] = 1;
                                drv.EndEdit();
                            }
                        }
