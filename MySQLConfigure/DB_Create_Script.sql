...
-- Add IS_CASH_BANK_STATUS if not present (after IS_MULTI_CURRENCY)
ALTER TABLE voucher_master_trans
ADD COLUMN IS_CASH_BANK_STATUS int(10) unsigned NOT NULL DEFAULT 1
COMMENT 'Default 1, Journal 0 if No Cash/Bank Involved'
AFTER IS_MULTI_CURRENCY;

UPDATE voucher_master_trans SET IS_CASH_BANK_STATUS = 0 WHERE VOUCHER_TYPE = 'JN';
...
--
-- Dumping routines for database 'dbemptyfma'
--
...
-- Dump completed on 2024-10-11 18:03:05
