...
namespace Bosco.DAO.Schema
{
    public class AppSchemaSet : CommonMember
    {
        ...
        public class ApplicationSchemaSet
        {
            ...
            private ApplicationSchema.AssetInOutCrDataTable assetInOutCr;
            public ApplicationSchema.AssetInOutCrDataTable AssetInOutCr
            {
                get
                {
                    if (assetInOutCr == null)
                    {
                        assetInOutCr = new ApplicationSchema.AssetInOutCrDataTable();
                    }
                    return assetInOutCr;
                }
            }
