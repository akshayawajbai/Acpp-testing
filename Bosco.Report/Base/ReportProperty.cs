...
namespace Bosco.Report.Base
{
    public class ReportProperty : CommonMember
    {
        ...
        //bharath 20/07/2026 for purpose id 
        ...
        public int ShowProvincePercentage { get; set; } //Added By Diensh 19-05-2026
        // #Dinesh 03-07-2026 - Selected company bank account id for payment advice report filter
        public Int32 PayrollPaymentBankAccountId { get; set; }
