...
namespace Bosco.Report.SQL
{
    public class ReportSQLCommand
    {
        ...
        {
            DayBookDuplicate, //Added By Dinesh 18-05-2026
            DayBookDetail,
            ChequeCleared,
            ChequeUncleared,
            ChequeRealiszed,
        ...
        public enum FinalAccounts
        {
            ...
            IsReportDateInFirstAccountingYear,
            IsNatures,
        ...
        {
            CCDetailCashBankBook,//added By Dinesh
            CCDetailCashandBankBookPay,//added By Dinesh
            ...
            CCDeatilCashBankJournal
        }

        public enum CashBankVoucher
        {
            FetchBankVoucherOnly,
