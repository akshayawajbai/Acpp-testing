    ...
    public partial class TrialBalance : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        public ResultArgs GetTrialBalance()
        {
            ...
            using (DataManager dataManager = new DataManager())
            {
                ...
                // 30/03/2026, Keep drill-down behavior unchanged; apply client-specific opening currency logic only in normal report mode.
                //dataManager.Parameters.Add("IS_SDBAFE", (!this.IsDrillDownMode && this.settingProperty.AllowMultiCurrency == 1 &&
                //    (this.settingProperty.IS_SDBAFE || this.settingProperty.IS_BSGRMG)) ? 1 : 0);
                dataManager.Parameters.Add("IS_SDBAFE", (!this.IsDrillDownMode && this.settingProperty.AllowMultiCurrency == 1 &&
        ...
        private void xrCellExcess_SummaryGetResult(object sender, SummaryGetResultEventArgs e)
        {
            ...
            {
                e.Result = MessageRender.GetMessage(MessageCatalog.Criteria.EXCESS_OF_EXPENDITURE_OVER_INCOME_TEXT);
                //e.Result = "Excess of Expenditure over Income";
                e.Handled = true;
            }
            else if (ExcessCreditAmount > ExcessDebitAmount)
            {
                e.Result = MessageRender.GetMessage(MessageCatalog.Criteria.EXCESS_OF_INCOME_OVER_INCOME_TEXT);
