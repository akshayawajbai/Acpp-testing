...
{
    public partial class TrialBalancePortrait : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        private void BindTrialBalance()
        {
            try
            {
                ...
                SetReportTitle();
                this.SetLandscapeHeader = xrtblLedgerHeaderCaption.WidthF; //1030.25f;
                this.SetLandscapeFooter = xrtblLedgerHeaderCaption.WidthF; // 1030.25f;
                ...
                else
                {
                    if (this.UIAppSetting.UICustomizationForm == "1")
                    {
                        if (ReportProperty.Current.ReportFlag == 0)
                        {
                            ...
                            if (this.ReportProperties.ShowDetailedBalance == 1)
                            {
                                ...
                                accountopBalance.CodeColumnWidth = xrTotalCodeCaption.WidthF;
                                accountopBalance.NameColumnWidth = xrTotalSumCaptions.WidthF + xrtblTotalSumOpeningDebitamt.WidthF;
                                accountopBalance.AmountColumnWidth = xrtblTotalSumOpeningCreditamount.WidthF;
                                accountopBalance.GroupNameWidth = xrTotalCodeCaption.WidthF + xrTotalSumCaptions.WidthF + xrtblTotalSumOpeningDebitamt.WidthF - 2; //75.35+187+126
                                accountopBalance.GroupAmountWidth = xrtblTotalSumOpeningCreditamount.WidthF;
                                ...
                                accountClosingBalance.CodeColumnWidth = xrtblTotalSumDebitCurrentTransAmount.WidthF;
                                accountClosingBalance.NameColumnWidth = xrTotalSumCreditCurrentTransAmount.WidthF + xrTotalSumClosingDebitAmount.WidthF;
                                accountClosingBalance.AmountColumnWidth = xrTotalSumClosingCreditAmount.WidthF;
                                accountClosingBalance.GroupNameWidth = xrtblTotalSumDebitCurrentTransAmount.WidthF + xrTotalSumCreditCurrentTransAmount.WidthF + xrTotalSumClosingDebitAmount.WidthF - 2;
                                accountClosingBalance.GroupAmountWidth = xrTotalSumClosingCreditAmount.WidthF;
                    ...
                    else
                    {
                        ...
                        if (this.ReportProperties.ShowDetailedBalance == 1)
                        {
                            ...
                            accountopBalance.NameColumnWidth = xrTotalSumCaptions.WidthF + xrtblTotalSumOpeningDebitamt.WidthF;
                            accountopBalance.AmountColumnWidth = xrtblTotalSumOpeningCreditamount.WidthF;
                            accountopBalance.GroupNameWidth = xrTotalCodeCaption.WidthF + xrTotalSumCaptions.WidthF + xrtblTotalSumOpeningDebitamt.WidthF - 2;
                            accountopBalance.GroupAmountWidth = xrtblTotalSumOpeningCreditamount.WidthF;
        ...
        public ResultArgs GetTrialBalance()
        {
            ...
            using (DataManager dataManager = new DataManager())
            {
                ...
                //---------------------------------------------------------------------------------------------------------------------------
                //bharath 21/07/2026
                dataManager.Parameters.Add("IS_SDBAFE", (!this.IsDrillDownMode && this.settingProperty.AllowMultiCurrency == 1 &&
                   (this.settingProperty.IS_BSGRMG)) ? 1 : 0);
        ...
        private void MakeShowOpeningCurrentPanels(bool showpanel, Int32 panel)
        {
            ...
            if (panel == 0 || panel == 2)
            {
                // Only set properties if the cell/control is not null and still attached to a parent row
                if (xrtblTotalSumDebitCurrentTransAmount != null && xrtblTotalSumDebitCurrentTransAmount.Row != null) xrtblTotalSumDebitCurrentTransAmount.WidthF = columwidh;
                if (xrTotalSumCreditCurrentTransAmount != null && xrTotalSumCreditCurrentTransAmount.Row != null) xrTotalSumCreditCurrentTransAmount.WidthF = columwidh;

                if (xrtblCurrentTransCashCredit != null && xrtblCurrentTransCashCredit.Row != null) xrtblCurrentTransCashCredit.WidthF = columwidh;
                if (xrtblCurrentTransBankCredit != null && xrtblCurrentTransBankCredit.Row != null) xrtblCurrentTransBankCredit.WidthF = columwidh;
                if (xrCellExcessCurrentTransCredit != null && xrCellExcessCurrentTransCredit.Row != null) xrCellExcessCurrentTransCredit.WidthF = columwidh;
                if (DifferCurTransCredit != null && DifferCurTransCredit.Row != null) DifferCurTransCredit.WidthF = columwidh;

                if (xrtblCurrentTransCashDebit != null && xrtblCurrentTransCashDebit.Row != null) xrtblCurrentTransCashDebit.WidthF = columwidh;
                if (xrtblCurrentTransBankDebit != null && xrtblCurrentTransBankDebit.Row != null) xrtblCurrentTransBankDebit.WidthF = columwidh;
                if (xrCellExcessCurrentTransDebit != null && xrCellExcessCurrentTransDebit.Row != null) xrCellExcessCurrentTransDebit.WidthF = columwidh;
                if (DifferCurTransDebit != null && DifferCurTransDebit.Row != null) DifferCurTransDebit.WidthF = columwidh;

                if (xrtblTotalSumDebitCurrentTransAmount != null && xrtblTotalSumDebitCurrentTransAmount.Row != null) xrtblTotalSumDebitCurrentTransAmount.Visible = showpanel;
                if (xrTotalSumCreditCurrentTransAmount != null && xrTotalSumCreditCurrentTransAmount.Row != null) xrTotalSumCreditCurrentTransAmount.Visible = showpanel;
                if (xrtblCurrentTransCashCredit != null && xrtblCurrentTransCashCredit.Row != null) xrtblCurrentTransCashCredit.Visible = showpanel;
                if (xrtblCurrentTransBankCredit != null && xrtblCurrentTransBankCredit.Row != null) xrtblCurrentTransBankCredit.Visible = showpanel;
                if (xrCellExcessCurrentTransCredit != null && xrCellExcessCurrentTransCredit.Row != null) xrCellExcessCurrentTransCredit.Visible = showpanel;
                if (DifferCurTransCredit != null && DifferCurTransCredit.Row != null) DifferCurTransCredit.Visible = showpanel;

                if (xrtblCurrentTransCashDebit != null && xrtblCurrentTransCashDebit.Row != null) xrtblCurrentTransCashDebit.Visible = showpanel;
                if (xrtblCurrentTransBankDebit != null && xrtblCurrentTransBankDebit.Row != null) xrtblCurrentTransBankDebit.Visible = showpanel;
                if (xrCellExcessCurrentTransDebit != null && xrCellExcessCurrentTransDebit.Row != null) xrCellExcessCurrentTransDebit.Visible = showpanel;
                if (DifferCurTransDebit != null && DifferCurTransDebit.Row != null) DifferCurTransDebit.Visible = showpanel;
            }

            if (panel == 0 || panel == 1)
            {
                if (xrtblTotalSumOpeningDebitamt != null && xrtblTotalSumOpeningDebitamt.Row != null) xrtblTotalSumOpeningDebitamt.WidthF = columwidh;
                if (xrtblTotalSumOpeningCreditamount != null && xrtblTotalSumOpeningCreditamount.Row != null) xrtblTotalSumOpeningCreditamount.WidthF = columwidh;
                if (xrtblCrOpeningTotalCashAmount != null && xrtblCrOpeningTotalCashAmount.Row != null) xrtblCrOpeningTotalCashAmount.WidthF = columwidh;
                if (xrtblCrOpeningBankAmount != null && xrtblCrOpeningBankAmount.Row != null) xrtblCrOpeningBankAmount.WidthF = columwidh;
                if (xrCellOpeningCredit != null && xrCellOpeningCredit.Row != null) xrCellOpeningCredit.WidthF = columwidh;
                if (DifferOpCredit != null && DifferOpCredit.Row != null) DifferOpCredit.WidthF = columwidh;
                if (xrtblDrOpeningTotalCashAmount != null && xrtblDrOpeningTotalCashAmount.Row != null) xrtblDrOpeningTotalCashAmount.WidthF = columwidh;
                if (xrtblDrOpeningBankAmount != null && xrtblDrOpeningBankAmount.Row != null) xrtblDrOpeningBankAmount.WidthF = columwidh;
                if (xrCellOpeningDebit != null && xrCellOpeningDebit.Row != null) xrCellOpeningDebit.WidthF = columwidh;
                if (diifferOpDebit != null && diifferOpDebit.Row != null) diifferOpDebit.WidthF = columwidh;
                if (xrtblTotalSumOpeningDebitamt != null && xrtblTotalSumOpeningDebitamt.Row != null) xrtblTotalSumOpeningDebitamt.Visible = showpanel;
                if (xrtblTotalSumOpeningCreditamount != null && xrtblTotalSumOpeningCreditamount.Row != null) xrtblTotalSumOpeningCreditamount.Visible = showpanel;

                if (xrtblCrOpeningTotalCashAmount != null && xrtblCrOpeningTotalCashAmount.Row != null) xrtblCrOpeningTotalCashAmount.Visible = showpanel;
                if (xrtblCrOpeningBankAmount != null && xrtblCrOpeningBankAmount.Row != null) xrtblCrOpeningBankAmount.Visible = showpanel;
                if (xrCellOpeningCredit != null && xrCellOpeningCredit.Row != null) xrCellOpeningCredit.Visible = showpanel;
                if (DifferOpCredit != null && DifferOpCredit.Row != null) DifferOpCredit.Visible = showpanel;
                if (xrtblDrOpeningTotalCashAmount != null && xrtblDrOpeningTotalCashAmount.Row != null) xrtblDrOpeningTotalCashAmount.Visible = showpanel;
                if (xrtblDrOpeningBankAmount != null && xrtblDrOpeningBankAmount.Row != null) xrtblDrOpeningBankAmount.Visible = showpanel;
                if (xrCellOpeningDebit != null && xrCellOpeningDebit.Row != null) xrCellOpeningDebit.Visible = showpanel;
                if (diifferOpDebit != null && diifferOpDebit.Row != null) diifferOpDebit.Visible = showpanel;
            }
        }
        #endregion
        ...
        private void ExpandTableForLandscape()
        {
            // Calculate available width
            float pageWidth = this.PageWidth - this.Margins.Left - this.Margins.Right;

            // Set the main table's width
            if (xrTrialBalance != null)
            {
                xrTrialBalance.WidthF = pageWidth;
                // Distribute width among only visible columns
                if (xrTrialBalance.Rows.Count > 0)
                {
                    foreach (XRTableRow row in xrTrialBalance.Rows)
                    {
                        ...
                        if (visibleCount > 0)
                        {
                            float colWidth = pageWidth / visibleCount;
                            foreach (XRTableCell cell in row.Cells)
                            {
                                if (cell.Visible)
        ...
        {
            //// [Uncommented and replaced on 2024-07-15 by AI]
            ...
            if (this.ReportProperties.ShowOpeningBalance != 0 && this.ReportProperties.ShowCurrentTransaction != 0) //by default
            {
                ...
                xrtblLedgerHeaderCaption.Visible = true;
                xrCellExcess.WidthF = xrCellallfooterDifferece.WidthF = xrTblClLedgerCode.WidthF + xrTblClLedger.WidthF;
                xrTableCellCash.WidthF = xrTableCellBank.WidthF = xrTotalSumCaptions.WidthF = xrTblClLedger.WidthF;
                xrClosingCashTotalDebit.WidthF = xrClosingBankDebitTotal.WidthF = xrcellExcessClosingDebit.WidthF = DifferClosingDebit.WidthF = xrTotalSumClosingDebitAmount.WidthF = xrTableClosingDebit.Width + 10;
                xrClosingCashTotalDebit.Visible = xrClosingBankDebitTotal.Visible = xrcellExcessClosingDebit.Visible = DifferClosingDebit.Visible = xrTotalSumClosingDebitAmount.Visible = xrClosingCashTotalDebit.Visible = true;
            }
            //// [Uncommented and replaced on 2024-07-15 by AI]
            ...
            //}
            else if (this.ReportProperties.ShowOpeningBalance == 1)
            {
                MakeShowOpeningCurrentPanels(false, 2);
                xrtblCrOpeningTotalCashAmount.WidthF = xrtblCrOpeningBankAmount.WidthF = xrCellOpeningCredit.WidthF = xrCellOpeningDebit.WidthF = xrtblTotalSumOpeningCreditamount.WidthF = 128 * 3;
                xrtblDrOpeningTotalCashAmount.WidthF = xrtblDrOpeningBankAmount.WidthF = diifferOpDebit.WidthF = DifferOpCredit.WidthF = xrtblTotalSumOpeningDebitamt.WidthF = 128 * 3;
            ...
            // Only set landscape and expand table if user selected landscape
            if (this.ReportProperties.PaperLandscape == 1)
            {
                //this.Landscape = false;
                // ExpandTableForLandscape();
            }
        }
