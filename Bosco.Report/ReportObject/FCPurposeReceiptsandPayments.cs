...
{
    public partial class FCPurposeReceiptsandPayments : Bosco.Report.Base.ReportHeaderBase
    {
        public FCPurposeReceiptsandPayments()
        {
            InitializeComponent();
        }
        ...
        private void LoadMonthlyAbstractReport()
        {
            ...
            FCPurposeReceipts montlyAbstractReceipts = xrSubreportMonthlyReceipts.ReportSource as FCPurposeReceipts;
            FCPurposePayments montlyAbstractPayments = xrSubreportMontlyPayments.ReportSource as FCPurposePayments;
