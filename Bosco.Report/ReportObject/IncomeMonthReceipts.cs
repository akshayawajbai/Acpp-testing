...
namespace Bosco.Report.ReportObject
{
    public partial class IncomeMonthReceipts : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        private ResultArgs GetReportSource()
        {
            ...
            string sqlMultiAbstractReceipts = this.GetFinalAccountsReportSQL(SQL.ReportSQLCommand.FinalAccounts.incomemonthly);
        ...
        private void xrPGMultiAbstractReceipt_FieldValueDisplayText(object sender, DevExpress.XtraReports.UI.PivotGrid.PivotFieldDisplayTextEventArgs e)
        {
            if (e.ValueType == DevExpress.XtraPivotGrid.PivotGridValueType.GrandTotal)
            {
                ...
                //e.DisplayText = "Total Income";
                e.DisplayText = MessageRender.GetMessage(MessageCatalog.Criteria.TOTAL_INCOME_TEXT);
            }
            else if (e.ValueType == DevExpress.XtraPivotGrid.PivotGridValueType.Total)
            {
                //e.DisplayText = "Total";
                e.DisplayText = MessageRender.GetMessage(MessageCatalog.Criteria.TOTAL_TEXT);
            }
        }
        ...
        private void SetFieldFontsPaperSize()
        {
            ...
            if (NoOfMonths <= 2)
            {
                ...
                fieldGROUPCODE.Width = 50; //50; //70
                fieldLEDGERCODE.Width = 50; //50;//70
