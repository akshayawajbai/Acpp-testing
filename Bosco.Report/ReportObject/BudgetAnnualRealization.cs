...
{
    public partial class BudgetAnnualRealization : Bosco.Report.Base.ReportHeaderBase
    {
        ResultArgs resultArgs = new ResultArgs();

        public BudgetAnnualRealization()
        {
            InitializeComponent();
        }
        #region Show Reports
        ...
        private void FetchBudgetDetails()
        {
            try
            {
                ...
                this.SetLandscapeBudgetNameWidth = xrSubQtlyBudgetIncomeLedgers.WidthF - 5;
                this.SetLandscapeHeader = xrSubQtlyBudgetIncomeLedgers.WidthF - 5;
                this.SetLandscapeFooter = xrSubQtlyBudgetIncomeLedgers.WidthF - 5;
                this.SetLandscapeFooterDateWidth = xrSubQtlyBudgetIncomeLedgers.WidthF - 5;
                SetTitleWidth(xrSubQtlyBudgetIncomeLedgers.WidthF - 5);
                ...
                //this.DisplayName = "Budget Realization - " + annualbudgetnames;
                ...
                if (AppSetting.IS_CMF_CONGREGATION)
                {
                    ...
                    ReportProperty.Current.BudgetName = string.Empty;
                    this.BudgetName = ReportProperty.Current.BudgetName;
                    string NewRpTitle = "Budget Realization";
                ...
                if (resultArgs.Success && resultArgs.DataSource.Table != null)
                {
                    ...
                    //}
                    //---------------------------------------------------------------------------------------------------------------------------------
                    BudgetAnnualRealizationLedgers xrBudgetAnnualQtlyIncomeLedgers = xrSubQtlyBudgetIncomeLedgers.ReportSource as BudgetAnnualRealizationLedgers;
                    ...
                    if (resultArgs.Success && resultArgs.DataSource.Table != null)
                    {
                        ...
                        //}
                        //---------------------------------------------------------------------------------------------------------------------------------
                        BudgetAnnualRealizationLedgers xrBudgetAnnualQtlyExpenseLedgers = xrSubQtlyBudgetExpenseLedgers.ReportSource as BudgetAnnualRealizationLedgers;
        ...
        private ResultArgs GetReportSource(TransMode budgetNature)
        {
            ...
            //string budgetvariance = this.GetBudgetvariance(SQL.ReportSQLCommand.BudgetVariance.BudgetRealization);
            string budgetvariance = this.IsSdbRmg ? this.GetBudgetvariance(SQL.ReportSQLCommand.BudgetVariance.BudgetRealizationActual) : this.GetBudgetvariance(SQL.ReportSQLCommand.BudgetVariance.BudgetRealization);
