...
{
    public partial class IncomeExpanditueYearSubRp : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        public IncomeExpanditueYearSubRp()
        {
            InitializeComponent();
        ...
        public void BindMultiAbstractReceiptSource(bool isreceipts)
        {
            ...
            if (IsMultiReceipts)
            {
                grpOpeningBalane.Visible = xrSubOpeningBalanceMulti.Visible = false;
        ...
        private ResultArgs GetReportSource(bool ReceiptReport)
        {
            ...
            string sqlMultiAbstractReceipts = this.GetFinalAccountsReportSQL(SQL.ReportSQLCommand.FinalAccounts.incomeandExpanforYearwise); //incomeandExpanforYearwise
            //  
            ...
            using (DataManager dataManager = new DataManager())
            {
                ...
                dataManager.Parameters.Add("IS_SDBAFE", (this.settingProperty.AllowMultiCurrency == 1 &&
        ...
        private void SetReportSetting(DataView dvReceipt, AccountBalanceMultiYear accountBalanceMultiYear)
        {
            ...
            fieldLEDGERCODE.SortMode = PivotSortMode.Custom;
            fieldLEDGERNAME.SortMode = PivotSortMode.Custom;
        ...
        private void BindGrandTotal(DataTable dtGrantTotal)
        {
            ...
            if (fieldCCName.Visible || fieldDonorName.Visible)
            {
                ...
                for (int col = 0; col < xrPGMultiAbstractReceipt.ColumnCount; col++)
                {
                    ...
                    drGrantTotal[reportSetting1.MultiAbstract.LEDGER_NAMEColumn.ColumnName] = IsMultiReceipts ? "TotalIncome" : "TotalExpenditure";
        ...
        private void xrPGMultiAbstractReceipt_CustomFieldSort(object sender, DevExpress.XtraReports.UI.PivotGrid.PivotGridCustomFieldSortEventArgs e)
        {
            ...
            else if (e.Field.Name == fieldLEDGERCODE.Name || e.Field.Name == fieldLEDGERNAME.Name)
            {
                string ledgerName1 = Convert.ToString(e.GetListSourceColumnValue(e.ListSourceRowIndex1, reportSetting1.MultiAbstract.LEDGER_NAMEColumn.ColumnName));
                string ledgerName2 = Convert.ToString(e.GetListSourceColumnValue(e.ListSourceRowIndex2, reportSetting1.MultiAbstract.LEDGER_NAMEColumn.ColumnName));

                e.Result = StringComparer.CurrentCultureIgnoreCase.Compare(ledgerName1, ledgerName2);
                e.Handled = true;
            }
        }
        ...
        private void xrPGMultiAbstractReceipt_FieldValueDisplayText(object sender, DevExpress.XtraReports.UI.PivotGrid.PivotFieldDisplayTextEventArgs e)
        {
            if (e.ValueType == DevExpress.XtraPivotGrid.PivotGridValueType.GrandTotal)
            {
                ...
                e.DisplayText = IsMultiReceipts ? "TotalIncome" : "TotalExpenditure";
            }
