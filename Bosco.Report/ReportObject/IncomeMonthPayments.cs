...
{
    public partial class IncomeMonthPayments : Bosco.Report.Base.ReportHeaderBase
    {
        public int NoOfMonths = 1;
        public bool ReceiptsAndPayments = false;
        Graphics gr = Graphics.FromHwnd(IntPtr.Zero);
        public IncomeMonthPayments()
        {
            InitializeComponent();
        ...
        private ResultArgs GetReportSource()
        {
            ...
            string sqlMultiAbstractPayments = this.GetFinalAccountsReportSQL(SQL.ReportSQLCommand.FinalAccounts.paymentmonthly);
        ...
        private void xrPGMultiAbstractPayment_FieldValueDisplayText(object sender, DevExpress.XtraReports.UI.PivotGrid.PivotFieldDisplayTextEventArgs e)
        {
            ...
            {
                e.DisplayText = "Total Expenditure";
            }
