...
namespace Bosco.Report.ReportObject
{
    public partial class MonthlyAbstractReceipts : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        public void BindReceiptSource()
        {
            ...
            if (resultArgs.Success)
            {
                ...
                if (dvReceipt != null)
                {
                    ...
                    {
                        ApplyBsgEspLedgerCodeRank(dvReceipt);
                    }
        ...
        private void SetReportSetting(DataView dvReceipt, AccountBalance accountBalance)
        {
            ...
            tcCapAmountBudget.Text = MessageRender.GetMessage(MessageCatalog.Criteria.BUDEGT_TEXT) + UtilityMember.DateSet.ToDate(settingProperty.YearFrom, false).Year + "-"
        ...
        private void ApplyBsgEspLedgerCodeRank(DataView dvReceipt)
        {
            if (dvReceipt == null || dvReceipt.Table == null)
            {
                return;
            }

            DataTable table = dvReceipt.Table;
        ...
        private void SortByLedgerorGroup()
        {
            ...
            // MINIMUM numeric Ledger-Code rank (BSGESP_CODE_RANK) they contain. That rank is built in BindReceiptSource
