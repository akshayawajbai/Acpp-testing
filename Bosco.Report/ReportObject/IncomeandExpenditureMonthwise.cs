...
{
    public partial class IncomeandExpenditureMonthwise : Bosco.Report.Base.ReportHeaderBase
    {
        public IncomeandExpenditureMonthwise()
        {
            InitializeComponent();
        ...
        private void LoadMultiAbstractReport()
        {
            ...
            IncomeMonthReceipts multiAbstractReceipts = xrSubMultiAbstractReceipt.ReportSource as IncomeMonthReceipts;
            IncomeMonthPayments multiAbstractPayments = xrSubMultiAbstractPayment.ReportSource as IncomeMonthPayments;
