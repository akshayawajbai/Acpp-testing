...
{
    public partial class FinancialStatement : Bosco.Report.Base.ReportHeaderBase
    {
        #region Constructor
        public FinancialStatement()
        {
            InitializeComponent();
            this.AttachDrillDownToRecord(xrTableSource, xrtblNameAddress,
        ...
        {
            //xrtblHeaderCaption = AlignHeaderTable(xrtblHeaderCaption); Dinesh 
            xrTableSource = AlignContentTable(xrTableSource);
            xrtblGrandTotal = AlignContentTable(xrtblGrandTotal);
           // this.SetCurrencyFormat(xrCapDebit.Text, xrCapDebit); Dinesh 
           // this.SetCurrencyFormat(xrCapCredit.Text, xrCapCredit); Dinesh 
        }
        ...
        private ResultArgs GetReportSource()
        {
            try
            {
                string DayBook = this.GetBankReportSQL(SQL.ReportSQLCommand.BankReport.DayBookDetail);
