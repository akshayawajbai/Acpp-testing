...
{
    public partial class FCPurposeReceipts : Bosco.Report.Base.ReportHeaderBase
    {
        #region Variables
        ...
        private DataTable GetReportSource()
        {
            try
            {
                ...
                string FCPurposeQueryPath = this.GetReportForeginContribution(isSDBRMGUser ? SQL.ReportSQLCommand.ForeginContribution.FCPurposeReceipts : SQL.ReportSQLCommand.ForeginContribution.FCPurpose);
