    ...
    public partial class MultiAbstractReceiptsYear : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        private void BindGrandTotal(DataTable dtGrantTotal)
        {
            ...
            if (fieldCCName.Visible || fieldDonorName.Visible)
            {
                ...
                for (int col = 0; col < xrPGMultiAbstractReceipt.ColumnCount; col++)
                {
                    ...
                    drGrantTotal[reportSetting1.MultiAbstract.LEDGER_NAMEColumn.ColumnName] = IsMultiReceipts ? MessageRender.GetMessage(MessageCatalog.Criteria.TOTAL_RECEIPTS) : MessageRender.GetMessage(MessageCatalog.Criteria.TOTAL_PAYAMENTS);
        ...
        private void xrPGMultiAbstractReceipt_FieldValueDisplayText(object sender, DevExpress.XtraReports.UI.PivotGrid.PivotFieldDisplayTextEventArgs e)
        {
            if (e.ValueType == DevExpress.XtraPivotGrid.PivotGridValueType.GrandTotal)
            {
                ...
                e.DisplayText = MessageRender.GetMessage(MessageCatalog.Criteria.TOTAL_TEXT) + (IsMultiReceipts ? MessageRender.GetMessage(MessageCatalog.Criteria.RECEIPTS_TEXT) : MessageRender.GetMessage(MessageCatalog.Criteria.PAYAMENT_TEXT));
            }
