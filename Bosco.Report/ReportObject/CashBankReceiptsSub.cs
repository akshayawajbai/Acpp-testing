    ...
    public partial class CashBankReceiptsSub : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        public void BindReport(bool DuplicateCopy = false)
        {
            if (!string.IsNullOrEmpty(ReportProperties.PrintCashBankVoucherId))
            {
                ...
                xrTblRequireSignNoteDuplicate.Visible = !ReportProperty.Current.HideReportSignNoteInFooter;
        ...
        private void xrtblRowPandetails_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (this.settingProperty.ShowGSTPan != "1")
            {
                xrtblRowPandetails.Visible = false;
            }
        }
