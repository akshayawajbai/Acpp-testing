...
{
    public partial class FCPurposePayments : Bosco.Report.Base.ReportHeaderBase
    {
        #region Variables
        ...
        {
            FCPurposeReport(true);
        }

        /// <summary>
        /// Used when this report is embedded as a subreport.
        /// Binds data but does not call base.ShowReport().
        /// </summary>
        public void BindPaymentSource()
        {
            FCPurposeReport(false);
        ...
        private void FCPurposeReport(bool callBaseShowReport)
        {
        ...
        private DataTable GetReportSource()
        {
            try
            {
                ...
                string FCPurposeQueryPath = this.GetReportForeginContribution(isSDBRMGUser ? SQL.ReportSQLCommand.ForeginContribution.FCPurposePayments : SQL.ReportSQLCommand.ForeginContribution.FCPurpose);
