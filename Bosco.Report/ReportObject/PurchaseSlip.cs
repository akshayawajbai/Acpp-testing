...
namespace Bosco.Report.ReportObject
{
    public partial class PurchaseSlip : Bosco.Report.Base.ReportHeaderBase
    {
        ...
        {
            //Commended By Dinesh 20-04-2026
            ...
            if (this.ReportProperties != null && this.ReportProperties.ModuleType == "Asset" && this.reportSetting1 != null && this.reportSetting1.CashBankReceipts != null)
            {
                var value = GetCurrentColumnValue(this.reportSetting1.CashBankReceipts.AMOUNT_TRANS_TYPEColumn.ColumnName);
                TransMode = value != null ? value.ToString() : "0";
            }
