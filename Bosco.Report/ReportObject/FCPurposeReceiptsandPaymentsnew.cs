...
{
    public partial class FCPurposeReceiptsandPaymentsnew : Bosco.Report.Base.ReportHeaderBase
    {
        #region Variables
        ...
        #region Constructor
        public FCPurposeReceiptsandPaymentsnew()
        {
            InitializeComponent();
            ...
            isSDBRMGUser = _appSetting.IS_SDB_RMG;
        }
        #endregion
        ...
        private DataTable GetReportSource()
        {
            try
            {
                ...
                //08/01/2026 
                // bharath 
                //for allow without donor info for sdgrmg users

                //string FCPurposeQueryPath = this.GetReportForeginContribution(SQL.ReportSQLCommand.ForeginContribution.FCPurpose);
                string FCPurposeQueryPath = this.GetReportForeginContribution(isSDBRMGUser ? SQL.ReportSQLCommand.ForeginContribution.FCPurposesdbrmg : SQL.ReportSQLCommand.ForeginContribution.FCPurpose);
                using (DataManager dataManager = new DataManager())
                {
                    dataManager.Parameters.Add(this.ReportParameters.DATE_FROMColumn, this.ReportProperties.DateFrom);
                    dataManager.Parameters.Add(this.ReportParameters.DATE_TOColumn, this.ReportProperties.DateTo);
                    dataManager.Parameters.Add(this.ReportParameters.PROJECT_IDColumn, this.ReportProperties.Project);
                    dataManager.Parameters.Add(this.ReportParameters.CONTRIBUTION_IDColumn, this.ReportProperties.Purpose_id);
        ...
        private void SetReportBorder()
        {
            ...
            this.SetCurrencyFormat(xrCapDebitAmount.Text, xrCapDebitAmount);
            this.SetCurrencyFormat(xrCapCreditAmount.Text, xrCapCreditAmount);
        }
        ...
        public bool isSDBRMGUser { get; set; }
    }
}
