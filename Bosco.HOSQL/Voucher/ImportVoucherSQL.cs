        ...
        private string GetImportVoucherQuery()
        {
            ...
            switch (sqlCommandId)
            {
                ...
                case SQLCommand.ImportVoucher.FetchTransactions:
                    {
                        sQuery = "SELECT VOUCHER_DATE, VOUCHER_ID, PROJECT_ID, CLIENT_CODE\n" +// Bharath 17/06/2026 - Added CLIENT_CODE for client-wise voucher deletion validation to sdbrmg.
                ...
                case SQLCommand.ImportVoucher.InsertVoucherMasterBranch:
                    {
                        sQuery = "INSERT INTO VOUCHER_MASTER_TRANS ( " +
                            ...
                            //"MODIFIED_BY_NAME," +
                               "BRANCH_ID," +
                               "LOCATION_ID," +
                               "GST_VENDOR_ID, GST_VENDOR_INVOICE_NO, GST_VENDOR_INVOICE_TYPE, GST_VENDOR_INVOICE_DATE,IS_MULTI_CURRENCY,IS_CASH_BANK_STATUS," +
                ...
                case SQLCommand.ImportVoucher.InsertVoucherTrans:
                    {
                        sQuery = "INSERT INTO VOUCHER_TRANS (\n" +
                               ...
                               "LEDGER_ID,\n" +
                               "AMOUNT,\n" +
                               "TRANS_MODE,LIVE_EXCHANGE_RATE,EXCHANGE_RATE,ACTUAL_AMOUNT,\n" +
                               "CHEQUE_NO,\n" +
                               "BRANCH_ID,\n" +
                ...
                case SQLCommand.ImportVoucher.InsertLedger:
                    {
                        sQuery = "INSERT INTO MASTER_LEDGER ( " +
                                   ...
                                   "GROUP_ID,  " +
                                   "LEDGER_TYPE, " +
                                   "LEDGER_SUB_TYPE, CUR_COUNTRY_ID,OP_EXCHANGE_RATE," +
                                   "IS_BRANCH_LEDGER," +
                                   "SORT_ID," +
                ...
                case SQLCommand.ImportVoucher.InsertLocalCountry:
                    {
                ...
                case SQLCommand.ImportVoucher.InsertCountryCurrency:
                    {
                        sQuery = "INSERT INTO MASTER_COUNTRY_CURRENCY_EXCHANGE_RATE ( " +
                              "COUNTRY_ID, " +
                              "APPLICABLE_FROM, " +
                              "APPLICABLE_TO, " +
                              "EXCHANGE_RATE,BRANCH_ID,LOCATION_ID) VALUES( " +
                              "?COUNTRY_ID, " +
                              "?APPLICABLE_FROM, " +
                              "?APPLICABLE_TO, " +
                              "?EXCHANGE_RATE,?BRANCH_ID,?LOCATION_ID) ";

                        break;
                    }
                case SQLCommand.ImportVoucher.UpdateCountryCurrency:
                    {
                        sQuery = "UPDATE MASTER_COUNTRY_CURRENCY_EXCHANGE_RATE \n" +
                                    "   SET APPLICABLE_FROM   = ?APPLICABLE_FROM,\n" +
                                    "       APPLICABLE_TO     = ?APPLICABLE_TO,\n" +
                                    "       EXCHANGE_RATE     = ?EXCHANGE_RATE,\n" +
                                    "       BRANCH_ID         = ?BRANCH_ID,\n" +
                                    "       LOCATION_ID       = ?LOCATION_ID\n" +
                                    " WHERE COUNTRY_ID = ?COUNTRY_ID AND APPLICABLE_FROM =?APPLICABLE_FROM AND APPLICABLE_TO =?APPLICABLE_TO;";
                        break;
                    }
                case SQLCommand.ImportVoucher.InsertState:
                    {
                        sQuery = "INSERT INTO STATE (STATE, STATE_CODE, COUNTRY_ID) VALUES (?STATE, ?STATE_CODE, ?COUNTRY_ID)";
                        break;
                    }
                case SQLCommand.ImportVoucher.InsertLocalState:
                    {
                        sQuery = "INSERT INTO master_state (STATE_NAME, STATE_CODE, COUNTRY_ID) VALUES (?STATE, ?STATE_CODE, ?COUNTRY_ID)";
                        break;
                    }
                ...
                case SQLCommand.ImportVoucher.InsertLedgerBank:
                    {
                        sQuery = "INSERT INTO MASTER_LEDGER ( " +
                                    ...
                                    "IS_BRANCH_LEDGER," +
                            //  "CUR_COUNTRY_ID," +
                                    "GROUP_ID,CUR_COUNTRY_ID,OP_EXCHANGE_RATE) " +
                                    "VALUES( " +
                                    "?LEDGER_CODE, " +
                                    "?LEDGER_NAME, " +
                                    "'BK'," +
                ...
                case SQLCommand.ImportVoucher.IsCountryCurrencyExists:
                    {
                        sQuery = "SELECT COUNT(*)\n" +
                                            "  FROM MASTER_COUNTRY_CURRENCY_EXCHANGE_RATE\n" +
                                            " WHERE COUNTRY_ID=?COUNTRY_ID AND APPLICABLE_FROM = ?APPLICABLE_FROM AND APPLICABLE_TO=?APPLICABLE_TO";
                        break;
                    }
                case SQLCommand.ImportVoucher.IsStateExists:
                    {
                        sQuery = "SELECT COUNT(*) FROM STATE\n" +
                                   " WHERE STATE = ?STATE";
                        break;
                    }
                ...
                case SQLCommand.ImportVoucher.GetLocalCountryId:
                    {
                        sQuery = "SELECT COUNTRY_ID\n" +
                                            "  FROM MASTER_COUNTRY\n" +
                                            " WHERE COUNTRY =?COUNTRY";
                ...
                case SQLCommand.ImportVoucher.GetCountryCurrencyId:
                    {
                        sQuery = "SELECT COUNTRY_ID\n" +
                                           "  FROM COUNTRY\n" +
                                           " WHERE COUNTRY =?COUNTRY";
                ...
                case SQLCommand.ImportVoucher.GetLocalStateId:
                    {
                        sQuery = "SELECT STATE_ID\n" +
                                            "  FROM MASTER_STATE\n" +
                                            " WHERE STATE_NAME =?STATE";
                ...
                case SQLCommand.ImportVoucher.InsertFDAccount:
                    {
                        ...
                        sQuery = "INSERT INTO FD_ACCOUNT\n" +
                                ...
                                "   INTEREST_RATE,\n" +
                                "   BRANCH_ID, \n" +
                                "   LOCATION_ID, CONTRIBUTION_AMOUNT,EXCHANGE_RATE,IS_MULTI_CURRENCY,ACTUAL_AMOUNT,CURRENCY_COUNTRY_ID,\n" +
