...
namespace ACPP.Modules.Inventory
{
    public partial class frmAssetClassView : frmFinanceBase
    {
        ...
        private void ucAssetGroups_EditClicked(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               // XtraMessageBox.Show("Fixed Asset Class can't be Edited", this.GetMessage(MessageCatalog.Common.COMMON_MESSAGE_TITLE), MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                // Implementation
                XtraMessageBox.Show(this.GetMessage(MessageCatalog.Common.GENERAL_ASSET_FIXED_ASSET_CLASS_CAN_EDITED), this.GetMessage(MessageCatalog.Common.COMMON_MESSAGE_TITLE), MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void ShowHide()
        {
            ...
            {
                //bharath 25/06/2026 Auditor license lock set
                ucAssetClass.VisibleAddButton = ucAssetClass.VisibleDeleteButton = ucAssetClass.VisibleEditButton = BarItemVisibility.Never;
            }
