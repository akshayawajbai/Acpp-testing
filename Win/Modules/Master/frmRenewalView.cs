            ...
            try
            {
                ...
                else
                {
                    ...
                    else if (fdTypes == FDTypes.RIN)
                    {
                        ...
                        //Implemantaion
                        this.ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_NO_RECORD_IS_AVAILABLE_RE_INVESTMENT));
                    }
                    else
                    {
                        this.ShowMessageBox(this.GetMessage(MessageCatalog.Master.FDRenewal.WITHDRAW_VIEW_NO_RECORD));
                    ...
                    else if (HasRenewals() == (int)YesNo.Yes)
                    {
                        ...
                        if (dtrenewal != null && dtrenewal.Rows.Count > 0)
                        {
                            ...
                            { 
                                ...
                                //Implemntaion
                                this.ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_SELECT_RENEWAL_DETAIL_FALL_YEAR));
                            }
                            else
                            {
                                if (!base.IsVoucherLockedForDate(ProjectId, RenewalDate, true))
                ...
                if (this.isEditable)
                {
                    ...
                    else if (HasRenewals() == (int)YesNo.Yes)
                    {
                        ...
                        else
                        {
                            ...
                            //Implemantaion
                            this.ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_FIXED_DEPOSIT_REINVESTMENT_NOT_FOUND));
                        }
                    }
                    else
                    {
