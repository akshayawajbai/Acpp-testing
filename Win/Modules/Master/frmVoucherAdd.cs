    ...
    public partial class frmVoucherAdd : frmFinanceBaseAdd
    {
            ...
            if (ValidateUserInput())
            {
                using (VoucherSystem voucherSystem = new VoucherSystem())
                {
                    ...
                    if (this.UtilityMember.NumberSet.ToInteger(lkpVoucherType.EditValue.ToString()) == (int)DefaultVoucherTypes.Contra)
                    {
                        ...
                        voucherSystem.PanEnabled = 0;
                        voucherSystem.GSTEnabled = 0;
                    }
                    else
                    {
                        voucherSystem.NarrationEnabled = chkEnableEntryNarration.Checked == true ? 1 : 0;
                        //bharath 04/06/2026 Ledger PAN and GST set
                        voucherSystem.PanEnabled = chkEnableEntryPan.Checked == true ? 1 : 0;
                        voucherSystem.GSTEnabled = chkEnableEntryGST.Checked == true ? 1 : 0;
                    }
            ...
            try
            {
                if (VoucherId != 0)
                {
                    using (VoucherSystem voucherSystem = new VoucherSystem(VoucherId))
                    {
                        ...
                        //bharath 04/06/2026 Ledger PAN and GST set
                        chkEnableEntryPan.Checked = voucherSystem.PanEnabled == 1 ? true : false;
                        chkEnableEntryGST.Checked = voucherSystem.GSTEnabled == 1 ? true : false;
                    }
                }
            }
            catch (Exception ex)
        ...
        private void ClearControls()
        {
            if (VoucherId.Equals(0))
            {
                ...
                //bharath 04/06/2026 Ledger PAN and GST set
                chkEnableEntryPan.Checked = false;
                chkEnableEntryGST.Checked = false;
            }
            txtVoucherName.Focus();
        }
