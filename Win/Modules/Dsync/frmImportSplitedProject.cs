    ...
    public partial class frmImportSplitedProject : frmFinanceBaseAdd
    {
        ...
        private void btnLoadXMLFile_Click(object sender, EventArgs e)
        {
            ...
            catch (ArgumentException errmissing)
            {
                ...
                // Implementation
                this.ShowMessageBoxWarning(this.GetMessage(MessageCatalog.Common.GENERAL_INVALID_ACMEERP_PROJECT_VOUCHER_DATA));
        ...
        private void btnImport_Click(object sender, EventArgs e)
        {
                          ...
                          MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.OK)
                    {
                        ...
                        if (resultargs != null && resultargs.Success)
                        {
                           ...
                           // ShowWaitDialog("Balance Refreshing all the Projects");
                            ...
                            // Implemetation
                            ShowWaitDialog(this.GetMessage(MessageCatalog.Common.GENERAL_BALANCE_ALL_REFERESIHG_PROJECTS));
            ...
            if (processed)
            {
                if (resultargs != null && resultargs.Success)
                {
                    ...
                    // Implementation
                    if (isBulkImport) msg = this.GetMessage(MessageCatalog.Common.GENERAL_PROJECT_IMPORTED_BEEN_SUCCESSFULLY);
        ...
        private bool ValidateLicenseKey()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    // Implemetation
                    this.ShowMessageBoxError(this.GetMessage(MessageCatalog.Common.GENERAL_INVALID_PROJECT_XML_DATA_LICENCE));
                    IsValid = false;
                }
            }
            catch (ArgumentException errmissing)
            {
                ...
                // Implementation 
                this.ShowMessageBoxError(this.GetMessage(MessageCatalog.Common.GENERAL_INVALID_ACME_PROJECT_VOUCHER_DATA));
        ...
        private bool IsInputValid()
        {
            ...
            else if (string.IsNullOrEmpty(XMLDateFrom) || string.IsNullOrEmpty(XMLDateTo))
            {
                ...
                // Implementation
                ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_DATE_RANGE_IS_NOT_AVAILABLE_XML));
                IsValid = false;
            }
            ...
            else
            {
                ...
                if (IsValid)
                {
                    ...
                    if (chkIncludeBudget.Checked)
                    {
                        if (MismatchBudgetProjectsWithDBProjects)
                        {
                            ...
                            if (NoOfBudgetProjects == 1)
                            {
                                ...
                                msg = this.GetMessage(MessageCatalog.Common.GENERAL_XML_BUDGET_CURRENT_BRANCH);
                    ...
                    { 
                        ...
                        // Implementation
                        this.ShowMessageBoxError(this.GetMessage(MessageCatalog.Common.GENERAL_FINANCE_YEAR_SPLITTING_OPTION));
                        IsValid = false;
                    }
                }
            }
            ...
            if (IsValid && XML_IsShowMappingLedger)
            {
                ...
                else
                {
                    ...
                    // Implementation 
                    this.ShowMessageBoxError(this.GetMessage(MessageCatalog.Common.GENERAL_MAP_LEDGER_OPTION_ENABLED));
                    IsValid = false;
                }
