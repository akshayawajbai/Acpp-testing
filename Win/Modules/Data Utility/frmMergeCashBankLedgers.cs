            ...
            if (ValidateAndConfirm())
            {
                using (MappingSystem mapping = new MappingSystem())
                {
                    ...
                    if (!resultArg.Success)
                    {
                        ...
                        //Implemataion
                        this.ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_NOT_ABLE_MERGE_CASH_BANK) + resultArg.Message );
                    }
                    else
                    {
                        updated = true;
            ...
            if (updated)
            {
                ...
                using (BalanceSystem balanceSystem = new BalanceSystem())
                {
                   ...
                   // this.ShowWaitDialog("Refreshing Ledger Balances");
                    //Implemantaion
                    this.ShowWaitDialog(this.GetMessage(MessageCatalog.Common.GENERAL_REFRESHING_LEDGER_BAL));
                    ...
                    if (!balancerefreshed)
                    {
                       ...
                       // this.ShowMessageBox("Successfully merged Cash/Bank Ledger but could not Refresh Project balance. Refresh it manually.(" + result.Message + ")");
                        ...
                        this.ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_SUCCESSFULLY_MERGED_CASH_BANK_PROJECT_BALANCE) + result.Message );
        ...
        private bool ValidateAndConfirm()
        {
            ...
            if (FromProjectId == 0 || MergeProjectId == 0 || FromProjectCashBankLedgerId == 0)
            {
                ...
                {  
                    ...
                    this.ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_SELECT_SOURCE_PROJECT));
                ...
                else if (MergeProjectId == 0)
                {
                    ...
                    //Implementation
                    this.ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_SELECT_MERGE_PROJECT));
                ...
                else if (FromProjectCashBankLedgerId == 0)
                {
                   ...
                   // this.ShowMessageBox("Select Source Cash/Bank Ledger");
                    ...
                    //Implementation
                    this.ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_SELECT_SOURCE_CASH_BANK_LEDGER));
            ...
            else if (FromProjectId == MergeProjectId && (FromProjectCashBankLedgerId == MergeProjectCashBankLedgerId && MergeProjectCashBankLedgerId==0))
            {
                ...
                //Implementation
                this.ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_SAME_PROJECT_CANT_MERGED));
