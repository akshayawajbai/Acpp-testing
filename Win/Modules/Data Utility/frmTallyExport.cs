...
namespace ACPP.Modules.Data_Utility
{
    public partial class frmTallyExport : frmFinanceBaseAdd
    {
        ...
        private void frmTallyMigration_Load(object sender, EventArgs e)
        {
            ...
            // Implementation
            this.ShowWaitDialog(this.GetMessage(MessageCatalog.Common.GENERAL_CONNECTING_TO_TALLY));
                            ...
                            if (resultargs.Success)
                            {
                                ...
                                if (dgresultOverwrite != DialogResult.Cancel)
                                {
                                    ...
                                    if (resultargs.Success)
                                    {
                                        ...
                                        msg = this.GetMessage(MessageCatalog.Common.GENERAL_EXPORT_TALLY_COMPLTED);
                                    }
                                    else
                                    {
                                        // Dinesh 07/07/2025
                                       ...
                                       // msg = "Export to Tally is not completed, " + resultargs.Message;
                                        ...
                                        // Implementation
                                        msg = this.GetMessage(MessageCatalog.Common.GENERAL_EXPORT_TALLY_NOT_COMPLETED) + resultargs.Message;
                                    }
                                    this.Cursor = Cursors.Default;
                                }
                                else
                                {
                                    ...
                                    // Implementation
                                    msg = this.GetMessage(MessageCatalog.Common.GENERAL_EXPORT_TALLY_CACELLED);
                                }
                            }
        ...
        private ResultArgs LoadCompanyInformation()
        {
            ...
            else
            {
                ...
                // Implementation
                resultArgs.Message = this.GetMessage(MessageCatalog.Common.GENERAL_COULD_NOT_CONNECT_TALLY_MORE_TALLY_IS_RUNNING);
            }
        ...
        private bool IsValidInputs()
        {
            ...
            if (ProjectId == 0)
            {
                ...
                // Implementation
                MessageRender.ShowMessage(this.GetMessage(MessageCatalog.Common.GENERAL_PROJECT_IS_EMPTY));
            ...
            else if (deFromDate.CompareTo(TallyBooksBeginningDate) < 0)
            {
                ...
                //Implementation
                MessageRender.ShowMessage(this.GetMessage(MessageCatalog.Common.GENERAL_DATE_FROM_EARLIER_TALLY_BOOK));
            ...
            else if (deFromDate.CompareTo(deToDate.Date) > 0)
            {
               ...
               // MessageRender.ShowMessage("Date To is lesser than Date To");
                // Implememtation
                MessageRender.ShowMessage(this.GetMessage(MessageCatalog.Common.GENERAL_DATE_TO_LESS_THEN_DATE_TO));
                ...
                if (!IsLicensedTally)
                {
                    if (deFromDate.Day <= 2)
                    {
                        ...
                        if (noofdays >= 2)
                        {
                            ...
                            MessageRender.ShowMessage(this.GetMessage(MessageCatalog.Common.GENERAL_TALLY_IS_NOT_RUNNING_LICENSED_MODE));
