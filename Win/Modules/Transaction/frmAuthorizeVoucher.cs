            ...
            try
            {
                if (gvTransaction.RowCount > 0)
                {
                    ...
                    if (SelectedIds.Length > 0)
                    {
                        ...
                        if (this.ShowConfirmationMessage(this.GetMessage(MessageCatalog.Common.GENERAL_ARE_YOU_SURE_AUTHORIZE_VOUCHERS), MessageBoxButtons.YesNo,
                           MessageBoxIcon.Question) == System.Windows.Forms.DialogResult.Yes)

                        {
                           ...
                           // this.ShowWaitDialog("Updating authorizing Vouchers");
                            ...
                            this.ShowWaitDialog(this.GetMessage(MessageCatalog.Common.GENERAL_UPDATING_AUTHORIZING_VOUCHERS));
                            ...
                            if (result.Success)
                            {
                               ...
                               // this.ShowMessageBox("Selected Voucher(s) are authorized");
                                ...
                                //Implementation
                                this.ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_SELECT_VOUCHERS_ARE_AUTHORIZED));
                            }
                            else
                            {
                    ...
                    else
                    {
                        ...
                        this.ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_SELECT_VOUCHERS_TO_BE_AUTHORIZED));
                    }
                }
            }
            catch (Exception ex)
            ...
            try
            {
                if (string.IsNullOrEmpty(SelectedVoucherType))
                {
                   ...
                   // this.ShowMessageBox("Select Voucher Type");
                    ...
                    //Implementation
                    this.ShowMessageBox(this.GetMessage(MessageCatalog.Common.GENERAL_SELECT_VOUCHER_TYPE));
                }
                else
                {
