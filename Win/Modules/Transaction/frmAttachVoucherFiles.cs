       ...
       #region Properties
        ...
        private void picRemoveCurrentImage_Click(object sender, EventArgs e)
        {
            try
            {
                if (imgsliderVoucherImageSlider.CurrentImage != null)
                {
                    ...
                    //Implmentation
                    if (this.ShowConfirmationMessage(this.GetMessage(MessageCatalog.Common.GENERAL_REMOVE_CURRENT_IMAGE_FILE), MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                       == System.Windows.Forms.DialogResult.Yes)
        ...
        private void btnReloadImages_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //    == System.Windows.Forms.DialogResult.OK)
                    ...
                    //Implemetation
                if (this.ShowConfirmationMessage(this.GetMessage(MessageCatalog.Common.GENERAL_LOAD_VOUCHER_FILES_FROM_BACKUP), MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
                   == System.Windows.Forms.DialogResult.OK)
                {
                    // Dinesh 07/07/2025
                    ...
                    //Implementation
                    this.ShowWaitDialog(this.GetMessage(MessageCatalog.Common.GENERAL_DOWNLOAD_VOUCHER_FILE_BACKUP));
        ...
        private void rbtnDeletePdfVoucher_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            if (!string.IsNullOrEmpty(VoucherPdfActualFileName) && gvPdfVouchers.FocusedRowHandle >= 0)
            {
                ...
                //Implementation
                if (this.ShowConfirmationMessage(this.GetMessage(MessageCatalog.Common.GENERAL_REMOVE_CURRENT_PDF_FILE_LIST), MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                   == System.Windows.Forms.DialogResult.Yes)
                {
        ...
        private void ShowPdfViewer()
        {
            if (!string.IsNullOrEmpty(VoucherPdfFileName) && !string.IsNullOrEmpty(VoucherFileRefPath)  && gvPdfVouchers.FocusedRowHandle >= 0)
            {
                ...
                else
                {
                    ...
                    //Implemetation
                    MessageRender.ShowMessage(this.GetMessage(MessageCatalog.Common.GENERAL_AVAILABLE_IN_LOCAL));
